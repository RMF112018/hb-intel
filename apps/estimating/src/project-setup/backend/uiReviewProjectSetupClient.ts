...
function createBaseRequest(
  ...
  return normalizeProjectSetupRequestFields({
    ...
    submittedAt: nowIso(),
    state: 'Submitted',
    groupMembers: ['pm@hb.com', 'lead.estimator@hb.com', 'team.member@hb.com', 'field.lead@hb.com'],
    groupLeaders: ['exec@hb.com'],
    department: 'commercial',
    retryCount: 0,
    projectExecutiveUpn: 'exec@hb.com',
    projectManagerUpn: 'pm@hb.com',
    leadEstimatorUpn: 'lead.estimator@hb.com',
    supportingEstimatorUpns: ['support.estimator@hb.com', 'pm@hb.com'],
    additionalTeamMemberUpns: ['team.member@hb.com', 'field.lead@hb.com'],
    timberscanApproverUpn: 'lead.estimator@hb.com',
  ...
  return {
    ...
    async submitRequest(data) {
      ...
      const request: IProjectSetupRequest = {
        ...
        projectExecutiveUpn: data.projectExecutiveUpn,
        projectManagerUpn: data.projectManagerUpn,
        leadEstimatorUpn: data.leadEstimatorUpn,
        supportingEstimatorUpns: data.supportingEstimatorUpns,
        additionalTeamMemberUpns: data.additionalTeamMemberUpns,
        timberscanApproverUpn: data.timberscanApproverUpn,
