/**
 * Runtime configuration for the My Dashboard app.
 *
...
export interface IRuntimeConfig {
  ...
  /** API audience URI for the HB Intel Function App (e.g. `api://<client-id>`). */
  apiAudience?: string;
}
 ...
 *
 * @throws {ConfigError} if no source provides the URL in production mode
 */
