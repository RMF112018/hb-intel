...
const EXPECTED_MVP_FIELDS: Readonly<Record<PublisherListKey, readonly string[]>> = {
  articles: [
    ...
    'TeamViewerMode', 'TeamViewerGroupingMode', 'TeamViewerSortMode',
    'TeamViewerMaxInitialVisible', 'TeamViewerAllowExpand',
    'SecondaryImage', 'SecondaryImageAltText', 'SecondaryImageCaption',
    'ShowSecondaryImage',
