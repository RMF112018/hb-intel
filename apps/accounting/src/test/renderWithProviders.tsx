...
import { HbcToastProvider, HbcThemeProvider } from '@hbc/ui-kit';
...
export function createTestSession(
  ...
  return {
    user: {
      ...
      email: 'test@hb.com',
      roles: [{ id: 'role-1', name: 'Controller', permissions: ['view', 'create', 'approve'] }],
    },
    providerIdentityRef: 'test-identity-ref',
    resolvedRoles: ['Controller'],
    permissionSummary: { grants: ['view', 'create', 'approve'], overrides: [] },
    runtimeMode: 'mock',
    issuedAt: now,
    validatedAt: now,
