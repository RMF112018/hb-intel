/**
 * SPFx webpart entry point for Operational Excellence.
 *
...
export interface IOperationalExcellenceWebPartProps {
  description: string;
}

/**
 * Operational Excellence SPFx webpart.
 *
 * Lifecycle:
 ...
 */
export default class OperationalExcellenceWebPart extends BaseClientSideWebPart<IOperationalExcellenceWebPartProps> {
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    return {
      pages: [
        {
          header: { description: 'Operational Excellence Webpart Settings' },
          groups: [
            {
              groupFields: [
