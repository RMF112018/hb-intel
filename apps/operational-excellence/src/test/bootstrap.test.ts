// D-PH7-BW-10: Bootstrap test for operational-excellence webpart
...
describe('bootstrapMockEnvironment (operational-excellence)', () => {
  beforeEach(() => {
  ...
  it('sets workspace to operational-excellence', () => {
    bootstrapMockEnvironment();
    expect(useNavStore.getState().activeWorkspace).toBe('operational-excellence');
  });
