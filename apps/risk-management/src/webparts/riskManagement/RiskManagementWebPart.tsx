/**
 * SPFx webpart entry point for Risk Management.
 *
 ...
 */
export default class RiskManagementWebPart extends BaseClientSideWebPart<IRiskManagementWebPartProps> {
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    return {
      pages: [
        {
          header: { description: 'Risk Management Webpart Settings' },
          groups: [
            {
              groupFields: [
