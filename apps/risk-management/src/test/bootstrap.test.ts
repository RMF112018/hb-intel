// D-PH7-BW-10: Bootstrap test for risk-management webpart
...
describe('bootstrapMockEnvironment (risk-management)', () => {
  beforeEach(() => {
  ...
  it('sets workspace to risk-management', () => {
    bootstrapMockEnvironment();
    expect(useNavStore.getState().activeWorkspace).toBe('risk-management');
  });
