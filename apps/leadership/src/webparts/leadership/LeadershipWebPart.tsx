/**
 * SPFx webpart entry point for Leadership.
 *
...
export interface ILeadershipWebPartProps {
  description: string;
}

/**
 * Leadership SPFx webpart.
 *
 * Lifecycle:
 ...
 */
export default class LeadershipWebPart extends BaseClientSideWebPart<ILeadershipWebPartProps> {
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    return {
      pages: [
        {
          header: { description: 'Leadership Webpart Settings' },
          groups: [
            {
              groupFields: [
