// D-PH7-BW-10: Bootstrap test for leadership webpart
...
describe('bootstrapMockEnvironment (leadership)', () => {
  beforeEach(() => {
  ...
  it('sets workspace to leadership', () => {
    bootstrapMockEnvironment();
    expect(useNavStore.getState().activeWorkspace).toBe('leadership');
  });
