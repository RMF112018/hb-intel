// D-PH7-BW-10: Bootstrap test for human-resources webpart
...
describe('bootstrapMockEnvironment (human-resources)', () => {
  beforeEach(() => {
  ...
  it('sets workspace to human-resources', () => {
    bootstrapMockEnvironment();
    expect(useNavStore.getState().activeWorkspace).toBe('human-resources');
  });
