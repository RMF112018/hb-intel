/**
 * SPFx webpart entry point for Human Resources.
 *
...
export interface IHumanResourcesWebPartProps {
  description: string;
}

/**
 * Human Resources SPFx webpart.
 *
 * Lifecycle:
 ...
 */
export default class HumanResourcesWebPart extends BaseClientSideWebPart<IHumanResourcesWebPartProps> {
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    return {
      pages: [
        {
          header: { description: 'Human Resources Webpart Settings' },
          groups: [
            {
              groupFields: [
