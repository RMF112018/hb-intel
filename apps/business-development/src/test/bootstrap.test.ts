// D-PH7-BW-10: Bootstrap test for business-development webpart
...
describe('bootstrapMockEnvironment (business-development)', () => {
  beforeEach(() => {
  ...
  it('sets workspace to business-development', () => {
    bootstrapMockEnvironment();
    expect(useNavStore.getState().activeWorkspace).toBe('business-development');
  });
