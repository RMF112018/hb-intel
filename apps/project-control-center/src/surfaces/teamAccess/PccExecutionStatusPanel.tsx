...
export const LANE_EXECUTION_STATUS_TONES: Readonly<Record<TeamAccessExecutionStatus, PccStatusPillTone>> = {
...
export const PccExecutionStatusPanel: FC<PccExecutionStatusPanelProps> = ({
  ...
  return (
    <div
      className={styles.executionStatusPanel}
      data-pcc-execution-status-panel="preview"
    >
        ...
        <div className={styles.tags}>
          {managerPersonas.map((persona) => (
            <span
              ...
              data-pcc-manager-persona={persona}
            >
              {persona}
            </span>
          ))}
      ...
      <p
        className={styles.auditPreviewLine}
        data-pcc-audit-preview-label=""
      >
        {auditPreviewLabel}
      </p>
