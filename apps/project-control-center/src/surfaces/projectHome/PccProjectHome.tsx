...
/**
 * Wave 2 / Prompt 05 — Project Home dashboard.
 *
 * Returns a fragment of `PccDashboardCard` children so each card remains a
 * direct DOM child of the surrounding `<PccBentoGrid>` (provided by
 * `PccShell`). The Prompt 03 corrective + Prompt 04 single-active-panel
 ...
 *     context.
 */
export const PccProjectHome: FC = () => (
  <Fragment>
