...
function activateProjectReadiness(): HTMLElement {
  // Phase 05 wave-b10 Prompt 04 — project-readiness is no longer
  // reachable as a primary tab. Render the legacy surface directly
  // inside <PccBentoGrid> to preserve the readiness-region invariants
  // in isolation. Buyout Log renders only when the 'buyout' detail
  // section is selected via the module-index card.
