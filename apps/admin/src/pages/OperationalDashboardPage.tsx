...
const useStyles = makeStyles({
  stateGrid: {
    display: 'grid',
    gridTemplateColumns: `repeat(auto-fill, minmax(${HBC_SPACE_XXL * 5 + HBC_SPACE_MD}px, 1fr))`,
  ...
  summaryCard: {
    flexGrow: 1,
    flexShrink: 1,
    flexBasis: `${HBC_SPACE_XXL * 6 + HBC_SPACE_SM}px`,
    padding: `${HBC_SPACE_MD}px`,
  },
  section: {
    marginTop: `${HBC_SPACE_MD + HBC_SPACE_SM}px`,
  },
  bottleneckRow: {
    display: 'flex',
    flexDirection: 'column',
