...
export const LANES: readonly LaneDefinition[] = [
  ...
  {
    id: 'white-glove-checkpoints',
    path: '/white-glove/checkpoints',
    label: 'WG Checkpoints',
    order: 13,
    status: 'active',
    permission: ADMIN_PERMISSION,
    hasSearchParams: false,
