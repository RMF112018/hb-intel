// D-PH7-BW-10: Bootstrap test for admin webpart
...
describe('bootstrapMockEnvironment (admin)', () => {
  beforeEach(() => {
  ...
  it('sets workspace to admin', () => {
    bootstrapMockEnvironment();
    expect(useNavStore.getState().activeWorkspace).toBe('admin');
  });
