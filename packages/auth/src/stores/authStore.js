...
export const useAuthStore = create((set) => ({
    ...
    isLoading: false,
    error: null,
    beginBootstrap: (runtimeMode) => set((state) => {
    ...
    completeBootstrap: (params) => set((state) => {
    ...
    resolveRestore: (result) => set((state) => {
        ...
        return {
            ...state,
            lifecyclePhase: result.outcome === 'restored'
                ? 'authenticated'
    ...
    signInSuccess: (session) => set((state) => {
        recordStructuredAuditEvent({
            eventType: 'sign-in',
    ...
    markReauthRequired: (failure = null) => set((state) => ({
        ...state,
    ...
    setStructuredError: (structuredError) => set((state) => ({
        ...state,
    ...
    clearStructuredError: () => set((state) => ({
        ...state,
        structuredError: null,
        error: null,
    ...
    setUser: (user) => set((state) => {
        ...
        const runtimeMode = fallbackMode === 'msal'
            ? 'pwa-msal'
            : fallbackMode === 'spfx'
                ? 'spfx-context'
                : fallbackMode;
 ...
 */
export const selectAuthLifecycle = (state) => ({
 ...
 */
export const selectAuthBootstrapReadiness = (state) => ({
 ...
 */
export const selectAuthSessionSummary = (state) => ({
 ...
 */
export const selectAuthPermissionSummary = (state) => ({
