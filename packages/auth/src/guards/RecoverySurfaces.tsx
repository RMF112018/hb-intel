 ...
 */
export function ShellBootstrapSurface({ onRetry }: RecoveryActionProps): ReactNode {
  return (
    <section aria-live="polite" data-hbc-auth-surface="bootstrap">
 ...
 */
export function SessionRestoreSurface({ onRetry }: RecoveryActionProps): ReactNode {
  return (
    <section aria-live="polite" data-hbc-auth-surface="restore">
 ...
 */
export function ExpiredSessionSurface({ onSignInAgain }: { onSignInAgain?: () => void }): ReactNode {
  return (
    <section aria-live="assertive" data-hbc-auth-surface="reauth-required">
 ...
 */
export function UnsupportedRuntimeSurface({ onRetry }: RecoveryActionProps): ReactNode {
  return (
    <section aria-live="assertive" data-hbc-auth-surface="unsupported-runtime">
 ...
 */
export function FatalStartupSurface({ onRetry }: RecoveryActionProps): ReactNode {
  return (
    <section aria-live="assertive" data-hbc-auth-surface="fatal-startup">
