 ...
 */
export type GuardFailureKind = 'runtime-unsupported' | 'unauthenticated' | 'reauth-required' | 'role-denied' | 'permission-denied';
/**
 ...
 */
export declare function resolveGuardResolution(input: GuardResolutionInput): GuardResolutionResult;
//# sourceMappingURL=guardResolution.d.ts.map