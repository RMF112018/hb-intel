 ...
 */
export const DEFAULT_SHELL_AUTH_CONFIGURATION = {
    runtimeRules: {
 ...
 */
export function resolveShellAuthConfiguration(input = {}) {
    return {
        runtimeRules: {
 ...
 */
export function validateShellAuthConfiguration(configuration) {
...
function validateSessionWindows(sessionWindows) {
...
function validatePolicySettings(policySettings) {
...
//# sourceMappingURL=configurationLayer.js.map