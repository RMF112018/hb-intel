 ...
 */
export type AuthFailureCode = 'missing-context' | 'expired-session' | 'unsupported-runtime' | 'access-validation-issue' | 'provider-bootstrap-failure' | 'unknown-fatal-initialization-failure';
/**
 ...
 */
export type ShellStatusTransition = 'restore-started' | 'restore-succeeded' | 'restore-reauth-required' | 'restore-failed' | 'restore-fatal';
/**
 * Phase 5.2 explicit restore outcome set.
 */
export type SessionRestoreOutcome = 'restored' | 'reauth-required' | 'invalid-expired' | 'fatal';
/**
 ...
 */
export type AuthLifecyclePhase = 'idle' | 'bootstrapping' | 'restoring' | 'authenticated' | 'reauth-required' | 'signed-out' | 'error';
/**
 ...
 */
export type AccessControlAuditEventType = 'sign-in' | 'sign-out' | 'session-restore-success' | 'session-restore-failure' | 'access-denied' | 'request-submitted' | 'request-approved' | 'request-rejected' | 'override-created' | 'override-modified' | 'override-revoked' | 'override-archived' | 'override-expired' | 'override-renewed' | 'emergency-access-used' | 'review-flag-generated' | 'review-flag-resolved' | 'admin-access-action' | 'base-role-updated';
/**
 * Structured source classification for audit event producers.
 */
export type AccessControlAuditEventSource = 'auth-store' | 'adapter' | 'guard' | 'workflow' | 'admin' | 'backend' | 'system';
/**
 ...
 */
export type AccessControlAdminSection = 'user-lookup' | 'role-access-lookup' | 'override-review' | 'renewal-queue' | 'role-change-review' | 'emergency-review' | 'audit-log';
/**
...
export interface AccessControlAdminRepository {
    ...
    resolveRoleChangeReview: (command: ResolveRoleChangeReviewCommand) => Promise<AccessControlWorkflowResult>;
    reviewEmergencyAccess: (command: ReviewEmergencyAccessCommand) => Promise<AccessControlWorkflowResult>;
}
/**
