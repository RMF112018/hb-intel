      ...
      <div style={summaryStyles.grid}>
        <div>
          ...
          <HbcTypography intent="body">
            {view.summary.rootCauseLabels[0] ?? 'Primary factor pending'}
          </HbcTypography>
        </div>
        <div>
          <HbcTypography intent="label">Key retrospective finding</HbcTypography>
          <HbcTypography intent="body">
            {view.summary.rootCauseLabels[0]
              ? `Root cause emphasized: ${view.summary.rootCauseLabels[0]}`
              : 'Retrospective finding pending author review.'}
          </HbcTypography>
        </div>
        <div>
          <HbcTypography intent="label">Reusable finding</HbcTypography>
          <HbcTypography intent="body">
            {view.benchmarkEnrichment.rootCauseCodes[0] ?? 'No reusable finding coded'}
          </HbcTypography>
          <HbcTypography intent="bodySmall">
            {topEvidence
