...
export {
  ...
  // Wave 14 — eight fixture families plus bridge fixtures.
  ...
  SAMPLE_APPROVAL_QUEUE_ENTRIES,
  SAMPLE_APPROVAL_QUEUE_VIEW,
  SAMPLE_MY_APPROVALS_VIEW,
  SAMPLE_ESCALATION_QUEUE_ENTRIES,
  SAMPLE_ESCALATION_QUEUE_VIEW,
  SAMPLE_ADMIN_VERIFICATION_QUEUE_ENTRIES,
...
} from './documentControlHomeFeed.js';

export {
  FIXTURE_UNKNOWN_PROJECT_ID,
  ...
  SAMPLE_PCC_EXTERNAL_SYSTEMS_LAUNCH_PAD_READ_MODEL_DEGRADED_SOURCE,
...
export {
  ...
  SAMPLE_PROCORE_DATA_LAYER_SOURCE_POSTURE,
...
export const PCC_FIXTURES = {
  ...
  approvals: {
    ...
    // Wave 14 — eight fixture families plus bridge.
    policies: SAMPLE_APPROVAL_POLICIES,
    policyVersions: SAMPLE_APPROVAL_POLICY_VERSIONS,
    checkpointDefinitions: SAMPLE_CHECKPOINT_DEFINITIONS,
    requests: SAMPLE_APPROVAL_REQUESTS,
    routes: SAMPLE_APPROVAL_ROUTES,
    steps: SAMPLE_APPROVAL_STEPS,
    participants: SAMPLE_APPROVAL_PARTICIPANTS,
    decisions: SAMPLE_APPROVAL_DECISIONS,
    auditEvents: SAMPLE_CHECKPOINT_AUDIT_EVENTS,
    sourceReferences: SAMPLE_CHECKPOINT_SOURCE_REFERENCES,
    evidenceLinks: SAMPLE_CHECKPOINT_EVIDENCE_LINKS,
    priorityActionLinks: SAMPLE_APPROVAL_PRIORITY_ACTION_LINKS,
    legacyCheckpointsAsInstances: SAMPLE_LEGACY_CHECKPOINTS_AS_INSTANCES,
    checkpointInstances: SAMPLE_CHECKPOINT_INSTANCES,
    queueView: SAMPLE_APPROVAL_QUEUE_VIEW,
    myApprovalsView: SAMPLE_MY_APPROVALS_VIEW,
    escalationQueueView: SAMPLE_ESCALATION_QUEUE_VIEW,
    adminVerificationQueueView: SAMPLE_ADMIN_VERIFICATION_QUEUE_VIEW,
    detailView: SAMPLE_APPROVAL_DETAIL_VIEW,
    registryView: SAMPLE_CHECKPOINT_REGISTRY_VIEW,
  ...
  integrations: {
    ...
    documentControlHomeFeed: SAMPLE_PCC_DOCUMENT_CONTROL_HOME_FEED,
    emptyDocumentControlHomeFeed: EMPTY_PCC_DOCUMENT_CONTROL_HOME_FEED,
  },
  externalSystemsLaunchPad: {
    systemDefinitions: SAMPLE_EXTERNAL_SYSTEM_DEFINITIONS,
    projectLaunchLinksKnownProject: SAMPLE_PROJECT_EXTERNAL_LAUNCH_LINKS_KNOWN_PROJECT,
    projectMappingsKnownProject: SAMPLE_PROJECT_EXTERNAL_SYSTEM_MAPPINGS_KNOWN_PROJECT,
    objectReferencesKnownProject: SAMPLE_EXTERNAL_OBJECT_REFERENCES_KNOWN_PROJECT,
    reviewItemsKnownProject: SAMPLE_EXTERNAL_REVIEW_ITEMS_KNOWN_PROJECT,
    healthSnapshotsKnownProject: SAMPLE_EXTERNAL_SYSTEM_HEALTH_SNAPSHOTS_KNOWN_PROJECT,
    auditEventsKnownProject: SAMPLE_EXTERNAL_SYSTEM_AUDIT_EVENTS_KNOWN_PROJECT,
    hbiLineageKnownProject: SAMPLE_HBI_SOURCE_LINEAGE_ENTRIES_KNOWN_PROJECT,
    readModelKnownProject: SAMPLE_PCC_EXTERNAL_SYSTEMS_LAUNCH_PAD_READ_MODEL_KNOWN_PROJECT,
    readModelUnknownProject: SAMPLE_PCC_EXTERNAL_SYSTEMS_LAUNCH_PAD_READ_MODEL_UNKNOWN_PROJECT,
    readModelDegradedSource: SAMPLE_PCC_EXTERNAL_SYSTEMS_LAUNCH_PAD_READ_MODEL_DEGRADED_SOURCE,
    readModelBackendUnavailable:
      SAMPLE_PCC_EXTERNAL_SYSTEMS_LAUNCH_PAD_READ_MODEL_BACKEND_UNAVAILABLE,
  },
  teamAccess: {
  ...
  procoreDataLayer: {
    ...
    readModel: SAMPLE_PROCORE_SYNC_HEALTH_READ_MODEL,
  },
  buyoutLog: {
