...
export const SAMPLE_PROJECT_MEMORY_READ_MODEL: PccProjectMemoryReadModel = {
  ...
  assumptions: SAMPLE_PROJECT_ASSUMPTION_RECORDS,
};
...
export const SAMPLE_PROJECT_TRACEABILITY_READ_MODEL: PccProjectTraceabilityReadModel = {
  ...
  graph: SAMPLE_TRACEABILITY_GRAPH_READ_MODEL,
  relatedLifecycleEvents: SAMPLE_PROJECT_LIFECYCLE_EVENTS,
...
export const SAMPLE_WARRANTY_TRACE_READ_MODEL: PccWarrantyTraceReadModel = {
  traces: [SAMPLE_WARRANTY_TRACE_RECORD, SAMPLE_WARRANTY_TRACE_INSUFFICIENT_EVIDENCE_RECORD],
};
...
export const SAMPLE_CROSS_PROJECT_KNOWLEDGE_READ_MODEL: PccCrossProjectKnowledgeReadModel = {
  ...
  knowledgeReferences: [SAMPLE_PROJECT_KNOWLEDGE_REFERENCE, SAMPLE_FUTURE_PURSUIT_KNOWLEDGE_REFERENCE],
  closedProjectReferences: {
    references: [SAMPLE_PROJECT_KNOWLEDGE_REFERENCE],
    futurePursuitReferences: [SAMPLE_FUTURE_PURSUIT_KNOWLEDGE_REFERENCE],
  },
};
