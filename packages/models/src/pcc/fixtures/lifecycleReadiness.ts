...
export const SAMPLE_LIFECYCLE_READINESS_PROJECT_ITEMS: readonly ILifecycleReadinessProjectItem[] =
  [
    ...
    },
    {
      ...
      approvalCheckpointReference: 'apc-startup-insurance-coi-001',
      posture: 'at-risk',
      severity: 'high',
      blockerState: 'open',
      confidence: 'medium',
    ...
    },
    {
      ...
      relatedPriorityActionId: 'pa-startup-systems-setup-003',
      posture: 'at-risk',
      severity: 'medium',
    ...
    },
    {
      ...
      approvalCheckpointReference: 'apc-safety-hot-work-permits-001',
      posture: 'at-risk',
      severity: 'high',
      blockerState: 'open',
      confidence: 'medium',
    ...
    },
    {
      ...
      relatedPriorityActionId: 'pa-closeout-owner-utility-setup-001',
      posture: 'blocked',
      severity: 'high',
      blockerState: 'open',
      confidence: 'medium',
