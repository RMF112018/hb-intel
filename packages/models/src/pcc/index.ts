...
export type {
  ...
  PccSiteUrl,
  // Wave 14 — Approvals & Checkpoints branded ids.
...
// Approval checkpoints (Wave 1 preserved + Wave 14 extension)
export {
  ...
  type ApprovalMode,
  type IApprovalModeCompletionRule,
  ...
  type RejectReturnReasonCode,
  type RequestRevisionReasonCode,
  type DeferReasonCode,
  type WaiveReasonCode,
  type OverrideReasonCode,
  type EscalateReasonCode,
  type CancelReasonCode,
  type SupersedeReasonCode,
  type ManualCloseReasonCode,
  // Wave 14 — Decision discriminated union.
  type ApprovalDecision,
  type IApprovalDecisionApprove,
  type IApprovalDecisionRejectReturn,
  type IApprovalDecisionRequestRevision,
  type IApprovalDecisionAcknowledge,
  type IApprovalDecisionDefer,
  type IApprovalDecisionWaive,
  type IApprovalDecisionOverride,
  type IApprovalDecisionEscalate,
  type IApprovalDecisionCancel,
  type IApprovalDecisionSupersede,
  type IApprovalDecisionManualClose,
  // Wave 14 — Domain interfaces.
  type IApprovalRequest,
  type IApprovalPolicy,
  type IApprovalPolicyVersion,
  type IApprovalRoute,
  type IApprovalStep,
  type IApprovalParticipant,
  // Wave 14 — Validation rules + role-action matrix.
  APPROVAL_VALIDATION_RULE_IDS,
  APPROVAL_VALIDATION_SEVERITIES,
  APPROVAL_VALIDATION_RULES,
  APPROVAL_ROLE_ACTION_MATRIX,
  isActionAllowedForRole,
  type ApprovalValidationRuleId,
  type ApprovalValidationSeverity,
  type IApprovalValidationRule,
  type IApprovalValidationFinding,
  // Wave 14 — Helpers.
  validateDecisionShape,
  isSupersededRequest,
  APPROVAL_ACTIONS_REQUIRING_EVIDENCE,
  requiresEvidenceForAction,
  // Wave 14 — HBI no-authority refusal.
  HBI_PRINCIPAL_KEY_PREFIX,
  HBI_FORBIDDEN_DECISION_ACTIONS,
  isHbiPrincipalKey,
  assertNoHbiAuthorityOnDecision,
  // Wave 14 — Audit + redaction vocabulary.
  APPROVAL_AUDIT_EVENT_TYPES,
  APPROVAL_REDACTION_CATEGORIES,
  APPROVAL_REDACTION_PRESERVED_CONTEXT,
  redactionContextPreservedFor,
  type ApprovalAuditEventType,
  type ApprovalRedactionCategory,
} from './ApprovalCheckpoint.js';

// Wave 14 — Checkpoint instance + read-model envelope shapes (downstream sibling).
export {
  ...
  type ICheckpointEvidenceLink,
  type ICheckpointSourceReference,
  type ICheckpointAuditEvent,
  type IApprovalPriorityActionLink,
  type ApprovalDecisionForReadModel,
  type IApprovalQueueEntry,
  type ApprovalQueueReadModel,
  type MyApprovalsReadModel,
  type ApprovalDetailReadModel,
  type CheckpointRegistryReadModel,
  type DecisionHistoryReadModel,
  type IEscalationQueueEntry,
  type EscalationQueueReadModel,
...
// Wave 15 — External Systems Launch Pad canonical contracts
export {
  ...
  type ExternalSystemAuditEventType,
  type ExternalSystemCategory,
  type ExternalSystemDegradedState,
  type ExternalSystemKey,
  type ExternalSystemLiveReadPosture,
  type ExternalSystemMappingState,
  type ExternalSystemMvpMode,
  type ExternalSystemPostureKind,
  type ExternalSystemRoleId,
  type ExternalSystemSourceHealthState,
  type ExternalSystemWritebackPolicy,
  type HbiAllowedCapability,
  type HbiRefusalReasonCode,
  type HbiRefusedCapability,
  type HbiSourceLineageState,
  type IExternalLauncherTypeRegistryEntry,
  type IExternalObjectReference,
  ...
  type IPccExternalObjectReferencesReadModel,
  type IPccExternalReviewItemsReadModel,
  type IPccExternalSystemAuditEventsReadModel,
  type IPccExternalSystemHealthSnapshotsReadModel,
  type IPccExternalSystemRegistryReadModel,
  type IPccExternalSystemsLaunchPadReadModel,
  type IPccExternalSystemsLaunchPadReadModelDegradedStateRow,
  type IPccExternalSystemsLaunchPadReadModelRoleAction,
  type IPccExternalSystemsLaunchPadReadModelSummary,
  type IPccExternalSystemsLaunchPadReadModelUrlPolicy,
  type IPccHbiSourceLineageReadModel,
  type IPccProjectExternalLaunchLinksReadModel,
  type IPccProjectExternalSystemMappingsReadModel,
  type IProjectExternalLaunchLink,
  type IProjectExternalSystemMapping,
  type PccExternalObjectReferencesReadModelEnvelope,
  type PccExternalReviewItemsReadModelEnvelope,
  type PccExternalSystemAuditEventsReadModelEnvelope,
  type PccExternalSystemHealthSnapshotsReadModelEnvelope,
  type PccExternalSystemRegistryReadModelEnvelope,
  type PccExternalSystemsLaunchPadReadModelEnvelope,
  type PccHbiSourceLineageReadModelEnvelope,
  type PccProjectExternalLaunchLinksReadModelEnvelope,
  type PccProjectExternalSystemMappingsReadModelEnvelope,
  type ProjectExternalLinkApprovalState,
} from './ExternalSystemsLaunchPad.js';

// Wave 15 — External URL policy helper
export {
  CREDENTIAL_LIKE_QUERY_PARAM_NAMES,
  EXTERNAL_URL_POLICY_CONTRACT,
  URL_POLICY_REASON_CODES,
  evaluateExternalUrlPolicy,
  type CredentialLikeQueryParamName,
  type IEvaluateExternalUrlPolicyInput,
...
export {
  ...
  DOCUMENT_CONTROL_HOME_FEED_MODES,
  DOCUMENT_CONTROL_HOME_FEED_SOURCES,
  DOCUMENT_CONTROL_HOME_FEED_ITEM_KINDS,
  DOCUMENT_CONTROL_HOME_FEED_CHANGE_KINDS,
  ...
  type DocumentControlHomeFeedSource,
  type DocumentControlHomeFeedItemKind,
  type DocumentControlHomeFeedChangeKind,
  type DocumentControlHomeFeedDeepLinkPosture,
  type DocumentControlHomeFeedPermissionPosture,
  ...
  type IPccDocumentControlHomeFeedBaseItem,
...
// Wave 13 Prompt 13C — Shared Procore Data Layer contracts
export {
  ...
  type PccProcoreDerivedSignalCategory,
  type PccProcoreDerivedSignalKind,
  type PccProcoreDerivedSignalSeverity,
  type PccProcoreFieldMutabilityClass,
  type PccProcoreFreshnessBand,
  type PccProcoreObjectLink,
  type PccProcoreSourceLineage,
  type PccProcoreSourceRefreshTrigger,
  type PccProcoreSourceState,
  type PccProcoreSubjectArea,
  type PccProcoreSubjectAreaClassification,
  type PccProcoreSubjectAreaId,
  type PccProcoreSubjectAreaReadPosture,
  type PccProcoreSubjectAreaRegistry,
  type PccProcoreSubjectAreaWritePosture,
  type PccProcoreSyncHealthEntry,
  type PccProcoreSyncHealthReadModel,
  type PccProcoreSyncState,
