...
Agents are specialist reviewers and investigators. Use them only when a separate specialist context reduces risk.

## Agents

| Agent | Use For |
| --- | --- |
| `hb-security-and-secrets-auditor` | Secrets, tokens, app settings, auth proof, redaction, sensitive artifacts. |
...
| `hb-boundary-auditor` | Package ownership, dependency direction, exports, platform primitive adoption. |
...
| `hb-docs-curator` | Documentation authority, classification, placement, drift, redundancy. |
...
2. tenant/deployment
3. SPFx parity
4. package boundaries / primitive adoption
5. plan review
6. verification
7. documentation
8. UI/UX
