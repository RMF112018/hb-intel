...
| Solution version                  | `1.1.66.0`                                            | same                                                                                           |
| Feature id                        | `c4e91f7d-8a23-4b56-9d0e-1f3c5a7b2d84`                | same                                                                                           |
| Feature version                   | `1.1.66.0`                                            | same                                                                                           |
...
| HbHomepageWebPart manifest version| `1.1.66.0`                                            | same                                                                                           |
...
| Artifact                                              | SHA-256                                                              |
|-------------------------------------------------------|----------------------------------------------------------------------|
| `dist/sppkg/hb-intel-homepage.sppkg`                  | `ba18794a999d2d4be87352f8f2d4ce1fd1b5988defc490ae9549107775706ee2`   |
...
- `versionAuthorityAligned` — **pass**. `solution.version`, `features[0].version`, and webpart manifest version all match at `1.1.66.0`.
...
- Packaged app bundle: `ClientSideAssets/hb-homepage-app-804c6d0d.js` (2,412,188 bytes, sha256 `804c6d0d…f63`).
...
1. Deploy `dist/sppkg/hb-intel-homepage.sppkg` (sha256 `ba18794a…06ee2`) to the tenant app catalog. Confirm the catalog shows `1.1.66.0`.
