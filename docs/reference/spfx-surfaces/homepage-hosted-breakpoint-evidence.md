...
| Solution version                  | `1.1.59.0`                                            | same                                                                                           |
| Feature id                        | `c4e91f7d-8a23-4b56-9d0e-1f3c5a7b2d84`                | same                                                                                           |
| Feature version                   | `1.1.59.0`                                            | same                                                                                           |
...
| HbHomepageWebPart manifest version| `1.1.59.0`                                            | same                                                                                           |
...
| Artifact                                              | SHA-256                                                              |
|-------------------------------------------------------|----------------------------------------------------------------------|
| `dist/sppkg/hb-intel-homepage.sppkg`                  | `704ddd2d0d01f5c7f697a750334251c4888a30bfcaec8e0ec6ea14a7b3e16b92`   |
| `dist/sppkg/hb-intel-homepage-effectiveness-proof.json` | `432646275286cc70b257b604bc2e513a23c78dcc9339dc9f83d212be75a4be25` |
| `dist/sppkg/hb-homepage-package-truth-proof.json`     | `44f8b15cb3eec7ab4c6b4ae130a5c65b309eee15258428205e83b14a09749d8c`   |
| `dist/sppkg/hb-homepage-shim-proof.json`              | `a17af7d6469b6b8ad2fa460d63ae37bafc87dad0336152822855cca9912cf224`   |
...
- `versionAuthorityAligned` — **pass**. `solution.version`, `features[0].version`, and webpart manifest version all match at `1.1.59.0`.
...
- Packaged app bundle: `ClientSideAssets/hb-homepage-app-dc6b6c2c.js` (2,398,152 bytes, sha256 `dc6b6c2c…f0`).
- Packaged shim entry for the HbHomepageWebPart id: `shell-entry-e0a11c44-e6d7-45d1-9af5-09ba0b68f5cf-7be7a3d0.js` (13,101 bytes).

**Package authority test.** `apps/hb-webparts/src/webparts/hbHomepage/__tests__/hbHomepagePackageAuthority.test.ts` enforces that `solution.version === features[0].version === webpart manifest version`. The build-time orchestrator (`tools/build-spfx-package.ts`) refuses to emit `.sppkg` when these diverge. Both gates pass at `1.1.59.0` in the current artifact set.
...
1. Deploy `dist/sppkg/hb-intel-homepage.sppkg` (sha256 `704ddd2d…e16b92`) to the tenant app catalog. Confirm the catalog shows `1.1.59.0`.
