...
## 1. Objective
- Tenant-backed schema/reference snapshot for `projectViewerGroups` at `https://hedrickbrotherscom.sharepoint.com/sites/HBCentral`.

## 2. List-Level Metadata
- List ID: `be157720-aef7-44c8-b4d2-babc4ea1dec5`
- Entity Type Name: `ProjectViewerGroupsList`
- URL: `https://hedrickbrotherscom.sharepoint.com/sites/HBCentral/Lists/projectViewerGroups/AllItems.aspx`
- Default View URL: `/sites/HBCentral/Lists/projectViewerGroups/AllItems.aspx`
- Root Folder URL: `/sites/HBCentral/Lists/projectViewerGroups`
...
| DefaultViewerGroupIdsJson | DefaultViewerGroupIdsJson | Note | No | No | No | No | RichText=false; Lines=6 |
| DefaultViewerGroupNames | DefaultViewerGroupNames | Text | No | No | No | No | MaxLength=255 |
| IsActive | IsActive | Choice | No | No | No | No | Choices: Yes, No; Default=No |
| LastReviewedAt | LastReviewedAt | DateTime | No | No | No | No |  |
...
| Department | LinkTitle | Computed | No | No | Yes | No | System/OOB-like |
...
- Default New Form: `/sites/HBCentral/Lists/projectViewerGroups/NewForm.aspx`
- Default Edit Form: `/sites/HBCentral/Lists/projectViewerGroups/EditForm.aspx`
- Default Display Form: `/sites/HBCentral/Lists/projectViewerGroups/DispForm.aspx`
