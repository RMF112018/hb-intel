...
## 1. Objective
- Tenant-backed schema/reference snapshot for `HB Article Promotion Rules` at `https://hedrickbrotherscom.sharepoint.com/sites/HBCentral`.

## 2. List-Level Metadata
- List ID: `1616667c-3984-4886-9d54-618d986f0456`
- Entity Type Name: `HB_x0020_Article_x0020_Promotion_x0020_RulesList`
- URL: `https://hedrickbrotherscom.sharepoint.com/sites/HBCentral/Lists/HB Article Promotion Rules/AllItems.aspx`
- Default View URL: `/sites/HBCentral/Lists/HB Article Promotion Rules/AllItems.aspx`
- Root Folder URL: `/sites/HBCentral/Lists/HB Article Promotion Rules`
...
- Default New Form: `/sites/HBCentral/Lists/HB Article Promotion Rules/NewForm.aspx`
- Default Edit Form: `/sites/HBCentral/Lists/HB Article Promotion Rules/EditForm.aspx`
- Default Display Form: `/sites/HBCentral/Lists/HB Article Promotion Rules/DispForm.aspx`
