...
## 1. Objective
- Tenant-backed schema/reference snapshot for `HB Article Media` at `https://hedrickbrotherscom.sharepoint.com/sites/HBCentral`.

## 2. List-Level Metadata
- List ID: `2a52a9ec-1432-4c59-8eec-b2c1c188ad45`
- Entity Type Name: `HB_x0020_Article_x0020_MediaList`
- URL: `https://hedrickbrotherscom.sharepoint.com/sites/HBCentral/Lists/HB Article Media/AllItems.aspx`
- Default View URL: `/sites/HBCentral/Lists/HB Article Media/AllItems.aspx`
- Root Folder URL: `/sites/HBCentral/Lists/HB Article Media`
...
- Default New Form: `/sites/HBCentral/Lists/HB Article Media/NewForm.aspx`
- Default Edit Form: `/sites/HBCentral/Lists/HB Article Media/EditForm.aspx`
- Default Display Form: `/sites/HBCentral/Lists/HB Article Media/DispForm.aspx`
- Appears Custom Forms (URL heuristic): `true`
- Observed Role Hint: `media child records`
