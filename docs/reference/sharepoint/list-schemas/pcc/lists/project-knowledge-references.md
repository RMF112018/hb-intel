# PCC Project Knowledge References

## 1. Objective
- Planned PCC schema/reference file for `PCC Project Knowledge References`.
...
| Knowledge ID | KnowledgeId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Related Cross Project References JSON | RelatedCrossProjectReferencesJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
