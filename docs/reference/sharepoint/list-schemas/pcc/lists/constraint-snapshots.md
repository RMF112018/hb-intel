# PCC Constraint Snapshots

## 1. Objective
- Planned PCC schema/reference file for `PCC Constraint Snapshots`.
...
| Exposure Summary JSON | ExposureSummaryJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
