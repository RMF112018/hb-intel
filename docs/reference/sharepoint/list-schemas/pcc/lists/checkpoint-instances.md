# PCC Checkpoint Instances

## 1. Objective
- Planned PCC schema/reference file for `PCC Checkpoint Instances`.
...
| Checkpoint Instance ID | CheckpointInstanceId | Text | Yes | No | No | Yes | Indexed for query/view performance |
