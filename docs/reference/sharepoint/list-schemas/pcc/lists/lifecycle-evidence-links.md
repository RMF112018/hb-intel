# PCC Lifecycle Evidence Links

## 1. Objective
- Planned PCC schema/reference file for `PCC Lifecycle Evidence Links`.
...
| External Reference Label | ExternalReferenceLabel | Text | No | No | No | No | MaxLength=255 |
...
- Observed Role Hint: `Lifecycle Readiness operational record`
