# PCC Lifecycle Readiness Project Items

## 1. Objective
- Planned PCC schema/reference file for `PCC Lifecycle Readiness Project Items`.
...
| Completed By Persona | CompletedByPersona | DateTime | No | No | No | No |  |
| Not Applicable Reason | NotApplicableReason | Note | No | No | No | No | RichText=false; Lines=6 |
| Deferred Reason | DeferredReason | Note | No | No | No | No | RichText=false; Lines=6 |
| Blocked Reason | BlockedReason | Note | No | No | No | No | RichText=false; Lines=6 |
| Exception Code | ExceptionCode | Text | Yes | No | No | No | MaxLength=255 |
| Evidence Link JSON | EvidenceLinkJson | Note | No | No | No | No | RichText=false; Lines=6 |
...
| Project Override Notes | ProjectOverrideNotes | Note | No | No | No | No | RichText=false; Lines=6 |
