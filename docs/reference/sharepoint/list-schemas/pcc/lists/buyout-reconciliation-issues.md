# PCC Buyout Reconciliation Issues

## 1. Objective
- Planned PCC schema/reference file for `PCC Buyout Reconciliation Issues`.
...
| Reconciliation Issue ID | ReconciliationIssueId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Opened At UTC | OpenedAtUtc | DateTime | Yes | No | No | No |  |
| Resolved At UTC | ResolvedAtUtc | DateTime | Yes | No | No | No |  |
| Resolution Rationale | ResolutionRationale | Note | No | No | No | No | RichText=false; Lines=6 |
