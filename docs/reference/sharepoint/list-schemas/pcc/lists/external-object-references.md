...
## 1. Objective
- Planned PCC schema/reference file for `PCC External Object References`.
...
| External Object Reference ID | ExternalObjectReferenceId | Text | No | No | No | Yes | Indexed for query/view performance |
...
| Object Type | ObjectType | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| External Object ID | ExternalObjectId | Text | No | No | No | Yes | Indexed for query/view performance |
| External Object Key | ExternalObjectKey | Text | No | No | No | Yes | Indexed for query/view performance |
