# PCC Readiness Evidence Links

## 1. Objective
- Planned PCC schema/reference file for `PCC Readiness Evidence Links`.
...
| Evidence Requirement ID | EvidenceRequirementId | Text | No | No | No | Yes | Indexed for query/view performance |
...
| Evidence State | EvidenceState | Choice | No | No | No | Yes | Indexed for query/view performance |
| Evidence Location Label | EvidenceLocationLabel | Text | No | No | No | No | MaxLength=255 |
...
| Evidence Reference ID | EvidenceReferenceId | Text | No | No | No | Yes | Indexed for query/view performance |
| External Reference Url | ExternalReferenceUrl | URL | No | No | No | No | Launch/reference value; no secrets or bearer tokens |
