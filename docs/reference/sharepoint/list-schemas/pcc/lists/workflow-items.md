...
## 1. Objective
- Planned PCC schema/reference file for `PCC Workflow Items`.
...
| Workflow Status | WorkflowStatus | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| Assigned To | AssignedTo | Text | Yes | No | No | No | MaxLength=255 |
| Due Date | DueDate | DateTime | Yes | No | No | Yes | Indexed for query/view performance |
| Created At | CreatedAt | DateTime | Yes | No | No | No |  |
| Updated At | UpdatedAt | DateTime | Yes | No | No | No |  |
