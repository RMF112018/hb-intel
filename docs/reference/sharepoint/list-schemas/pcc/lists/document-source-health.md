# PCC Document Source Health

## 1. Objective
- Planned PCC schema/reference file for `PCC Document Source Health`.
...
| Source Health ID | SourceHealthId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Observed At UTC | ObservedAtUtc | DateTime | Yes | No | No | No |  |
| Last Successful Check UTC | LastSuccessfulCheckUtc | DateTime | Yes | No | No | No |  |
| Failure Count | FailureCount | Number | Yes | No | No | No |  |
