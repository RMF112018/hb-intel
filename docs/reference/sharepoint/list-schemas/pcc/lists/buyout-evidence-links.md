# PCC Buyout Evidence Links

## 1. Objective
- Planned PCC schema/reference file for `PCC Buyout Evidence Links`.
...
| Buyout Evidence Link ID | BuyoutEvidenceLinkId | Text | No | No | No | Yes | Indexed for query/view performance |
...
| Share Point Reference ID | SharePointReferenceId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Added At UTC | AddedAtUtc | DateTime | Yes | No | No | No |  |
| Added By Person Ref | AddedByPersonRef | Text | Yes | No | No | No | MaxLength=255 |
