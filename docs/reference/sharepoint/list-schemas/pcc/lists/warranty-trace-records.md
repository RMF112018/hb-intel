# PCC Warranty Trace Records

## 1. Objective
- Planned PCC schema/reference file for `PCC Warranty Trace Records`.
...
| Warranty Trace ID | WarrantyTraceId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Issue Summary | IssueSummary | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Estimate Reference Record ID | EstimateReferenceRecordId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Scope Reference Record ID | ScopeReferenceRecordId | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| Obligation Trace JSON | ObligationTraceJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Vendor Product Trace JSON | VendorProductTraceJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Related Lifecycle Event IDs JSON | RelatedLifecycleEventIdsJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Related Memory IDs JSON | RelatedMemoryIdsJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Traceability Edges JSON | TraceabilityEdgesJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Evidence Links JSON | EvidenceLinksJson | Note | No | No | No | No | RichText=false; Lines=6 |
| Recommendation JSON | RecommendationJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Security JSON | SecurityJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
