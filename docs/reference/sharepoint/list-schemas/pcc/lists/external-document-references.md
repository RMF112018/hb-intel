# PCC External Document References

## 1. Objective
- Planned PCC schema/reference file for `PCC External Document References`.
...
| External Document Reference ID | ExternalDocumentReferenceId | Text | No | No | No | Yes | Indexed for query/view performance |
...
| External Object ID | ExternalObjectId | Text | No | No | No | Yes | Indexed for query/view performance |
| External Object Type | ExternalObjectType | Choice | No | No | No | Yes | Indexed for query/view performance |
...
| Access State | AccessState | Choice | Yes | No | No | Yes | Indexed for query/view performance |
