# PCC Permit Inspection Audit Events

## 1. Objective
- Planned PCC schema/reference file for `PCC Permit Inspection Audit Events`.
...
| Action | Action | Choice | Yes | No | No | No |  |
| Prior Value | PriorValue | Number | No | No | No | No |  |
| New Value | NewValue | Number | Yes | No | No | No |  |
