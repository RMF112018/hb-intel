# PCC Procore Derived Signals

## 1. Objective
- Planned PCC schema/reference file for `PCC Procore Derived Signals`.
...
| Derived Signal ID | DerivedSignalId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Signal Kind | SignalKind | Choice | Yes | No | No | No |  |
...
| Object Link ID | ObjectLinkId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Hbi Grounding Citation ID | HbiGroundingCitationId | Text | Yes | No | No | Yes | Indexed for query/view performance |
