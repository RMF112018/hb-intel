# PCC Cross Project References

## 1. Objective
- Planned PCC schema/reference file for `PCC Cross Project References`.
- Category: `Project Memory / Traceability / HBI Grounding`.
- Storage posture: `Global / HBCentral knowledge registry`.
...
- Description: `Project Memory / Traceability / HBI Grounding / Global / HBCentral knowledge registry`
- Hidden: `false`
- Item Count: ``
...
| Reference ID | ReferenceId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| From Project ID | FromProjectId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| To Project ID | ToProjectId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Reason | Reason | Note | No | No | No | No | RichText=false; Lines=6 |
| Classification | Classification | Choice | Yes | No | No | No |  |
| Reference Type | ReferenceType | Choice | Yes | No | No | No |  |
| Status | Status | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| Eligible Lens Types JSON | EligibleLensTypesJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
