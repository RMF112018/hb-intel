...
## 1. Objective
- Planned PCC schema/reference file for `PCC Approval Steps`.
...
| Approval Route ID | ApprovalRouteId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Step Number | StepNumber | Number | Yes | No | No | No |  |
| Approval Mode | ApprovalMode | Choice | Yes | No | No | No |  |
| Assigned Role | AssignedRole | Text | Yes | No | No | No | MaxLength=255 |
| Assigned Principal Key | AssignedPrincipalKey | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Delegation Allowed | DelegationAllowed | Boolean | Yes | No | No | No |  |
| Completion Rule | CompletionRule | Text | Yes | No | No | No | MaxLength=255 |
| Step State | StepState | Choice | Yes | No | No | Yes | Indexed for query/view performance |
