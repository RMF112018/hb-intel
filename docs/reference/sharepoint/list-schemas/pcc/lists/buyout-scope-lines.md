# PCC Buyout Scope Lines

## 1. Objective
- Planned PCC schema/reference file for `PCC Buyout Scope Lines`.
...
| Scope Line ID | ScopeLineId | Choice | Yes | No | No | Yes | Indexed for query/view performance |
...
| Quantity | Quantity | Number | Yes | No | No | No |  |
| Unit | Unit | Text | Yes | No | No | No | MaxLength=255 |
| Scope Status | ScopeStatus | Choice | Yes | No | No | Yes | Indexed for query/view performance |
