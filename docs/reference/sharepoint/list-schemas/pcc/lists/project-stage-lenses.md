# PCC Project Stage Lenses

## 1. Objective
- Planned PCC schema/reference file for `PCC Project Stage Lenses`.
...
| Lens ID | LensId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Project ID | ProjectId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Lens Type | LensType | Choice | Yes | No | No | No |  |
| Visibility Mode | VisibilityMode | Choice | Yes | No | No | No |  |
| Lifecycle Stage | LifecycleStage | Choice | Yes | No | No | No |  |
| Project Stage | ProjectStage | Choice | Yes | No | No | No |  |
| Role | Role | Text | Yes | No | No | No | MaxLength=255 |
| Task Focus JSON | TaskFocusJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Included Memory IDs JSON | IncludedMemoryIdsJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Included Event IDs JSON | IncludedEventIdsJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Included Trace Edge IDs JSON | IncludedTraceEdgeIdsJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
