# PCC Document Control Actions

## 1. Objective
- Planned PCC schema/reference file for `PCC Document Control Actions`.
...
| Document Control Action ID | DocumentControlActionId | Choice | Yes | No | No | Yes | Indexed for query/view performance |
...
| Action Code | ActionCode | Choice | Yes | No | No | No |  |
| Action Family | ActionFamily | Choice | Yes | No | No | No |  |
| Action Label | ActionLabel | Choice | Yes | No | No | No |  |
...
| Completed By UPN | CompletedByUpn | DateTime | No | No | No | No |  |
