# PCC HBI Refusal Events

## 1. Objective
- Planned PCC schema/reference file for `PCC HBI Refusal Events`.
- Category: `Project Memory / Traceability / HBI Grounding`.
- Storage posture: `Project site or HBCentral depending on scope`.
...
- Description: `Project Memory / Traceability / HBI Grounding / Project site or HBCentral depending on scope`
- Hidden: `false`
- Item Count: ``
...
| Refusal Event ID | RefusalEventId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Project ID | ProjectId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Query | Query | Text | Yes | No | No | No | MaxLength=255 |
| Response | Response | Text | Yes | No | No | No | MaxLength=255 |
| Refusal Reason | RefusalReason | Note | No | No | No | No | RichText=false; Lines=6 |
...
| Related Record IDs JSON | RelatedRecordIdsJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
