# PCC Procore Object Links

## 1. Objective
- Planned PCC schema/reference file for `PCC Procore Object Links`.
...
| Procore Object Link ID | ProcoreObjectLinkId | Text | No | No | No | Yes | Indexed for query/view performance |
...
| Procore Object Key | ProcoreObjectKey | Text | No | No | No | Yes | Indexed for query/view performance |
