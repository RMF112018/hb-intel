...
## 1. Objective
- Planned PCC schema/reference file for `PCC Repair Requests`.
...
| Site Health Check ID | SiteHealthCheckId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Requested By UPN | RequestedByUpn | Text | Yes | No | No | No | MaxLength=255 |
| Requested By Persona | RequestedByPersona | Text | Yes | No | No | No | MaxLength=255 |
...
| Evidence Summary | EvidenceSummary | Note | No | No | No | No | RichText=false; Lines=6 |
| Owner Persona | OwnerPersona | Text | Yes | No | No | No | MaxLength=255 |
| Repair State | RepairState | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| Decided At UTC | DecidedAtUtc | DateTime | Yes | No | No | No |  |
| Decision By UPN | DecisionByUpn | Text | Yes | No | No | No | MaxLength=255 |
| Decision Note | DecisionNote | Text | No | No | No | No | MaxLength=255 |
