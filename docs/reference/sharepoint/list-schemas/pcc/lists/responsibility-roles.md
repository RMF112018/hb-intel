# PCC Responsibility Roles

## 1. Objective
- Planned PCC schema/reference file for `PCC Responsibility Roles`.
- Category: `Responsibility Matrix`.
- Storage posture: `Project site or global registry`.
...
- Description: `Responsibility Matrix / Project site or global registry`
- Hidden: `false`
- Item Count: ``
...
| Role Code | RoleCode | Text | Yes | No | No | No | MaxLength=255 |
...
| Mapped Permission Template Key | MappedPermissionTemplateKey | Text | Yes | No | No | Yes | Indexed for query/view performance |
