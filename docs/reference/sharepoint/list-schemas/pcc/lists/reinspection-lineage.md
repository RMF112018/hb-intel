# PCC Reinspection Lineage

## 1. Objective
- Planned PCC schema/reference file for `PCC Reinspection Lineage`.
...
| Lineage ID | LineageId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Project ID | ProjectId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Parent Inspection ID | ParentInspectionId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Child Reinspection ID | ChildReinspectionId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Failed Item Summary | FailedItemSummary | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Corrective Action Owner | CorrectiveActionOwner | Text | Yes | No | No | No | MaxLength=255 |
| Corrective Action Due Date | CorrectiveActionDueDate | DateTime | Yes | No | No | Yes | Indexed for query/view performance |
| Reinspection Required | ReinspectionRequired | Boolean | Yes | No | No | No |  |
| Reinspection Requested Date | ReinspectionRequestedDate | DateTime | Yes | No | No | No |  |
| Reinspection Scheduled Window | ReinspectionScheduledWindow | DateTime | Yes | No | No | No |  |
| Re Inspection Fee | ReInspectionFee | Number | Yes | No | No | No |  |
| Reinspection Result | ReinspectionResult | Text | Yes | No | No | No | MaxLength=255 |
