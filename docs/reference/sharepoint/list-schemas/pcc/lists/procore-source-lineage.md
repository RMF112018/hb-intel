# PCC Procore Source Lineage

## 1. Objective
- Planned PCC schema/reference file for `PCC Procore Source Lineage`.
...
| Procore Object ID | ProcoreObjectId | Text | No | No | No | Yes | Indexed for query/view performance |
| Procore Object Type | ProcoreObjectType | Choice | No | No | No | Yes | Indexed for query/view performance |
| Captured At UTC | CapturedAtUtc | DateTime | Yes | No | No | No |  |
| Refresh Trigger | RefreshTrigger | Text | Yes | No | No | No | MaxLength=255 |
| Source Endpoint Version | SourceEndpointVersion | Text | Yes | No | No | No | MaxLength=255 |
| Owning Provider | OwningProvider | Text | Yes | No | No | No | MaxLength=255 |
