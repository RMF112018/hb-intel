# PCC Responsibility Exceptions

## 1. Objective
- Planned PCC schema/reference file for `PCC Responsibility Exceptions`.
...
| Responsibility Exception ID | ResponsibilityExceptionId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Code | Code | Text | Yes | No | No | No | MaxLength=255 |
| Severity | Severity | Choice | Yes | No | No | No |  |
| Summary | Summary | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Related Item ID | RelatedItemId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Resolved By UPN | ResolvedByUpn | Text | Yes | No | No | No | MaxLength=255 |
