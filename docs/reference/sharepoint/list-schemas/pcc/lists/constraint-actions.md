# PCC Constraint Actions

## 1. Objective
- Planned PCC schema/reference file for `PCC Constraint Actions`.
...
| Constraint Action ID | ConstraintActionId | Choice | Yes | No | No | Yes | Indexed for query/view performance |
...
| Action Description | ActionDescription | Note | No | No | No | No | RichText=false; Lines=6 |
