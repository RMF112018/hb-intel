...
## 1. Objective
- Planned PCC schema/reference file for `PCC Project External Launch Links`.
...
| Launch Link ID | LaunchLinkId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Launch State | LaunchState | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| Launch Url | LaunchUrl | URL | No | No | No | No | Launch/reference value; no secrets or bearer tokens |
| Opens In New Window | OpensInNewWindow | Text | Yes | No | No | No | MaxLength=255 |
...
| Required Before | RequiredBefore | Text | Yes | No | No | No | MaxLength=255 |
| Severity | Severity | Choice | Yes | No | No | No |  |
| Owner Persona | OwnerPersona | Text | Yes | No | No | No | MaxLength=255 |
| Missing Config Message | MissingConfigMessage | Note | No | No | No | No | RichText=false; Lines=6 |
