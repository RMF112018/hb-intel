...
| Project ID            | ProjectId           | Text     | No       | No     | No        | Yes     | Optional legacy partition key; global defaults should not depend on project-specific rows.   |
| Configuration ID      | ConfigurationId     | Text     | Yes      | No     | No        | Yes     | Indexed for query/view performance                                                           |
| Application Key       | ApplicationKey      | Choice   | Yes      | No     | No        | Yes     | Choices: `PCC`, `Platform`, `Integrations`; indexed for query/view performance               |
...
| Scope Key             | ScopeKey            | Choice   | Yes      | No     | No        | Yes     | Choices: `Global`, `Environment`, `Service`; indexed for query/view performance              |
| Scope                 | Scope               | Choice   | Yes      | No     | No        | Yes     | Choices: `Tenant`, `Platform`, `Application`; indexed for read-model filtering               |
...
- Global defaults are authoritative in this registry; project-specific overrides are stored in `control-center-setting-overrides`.
