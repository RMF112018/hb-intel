...
| Config Value | ConfigValue | Number | Yes | No | No | No |  |
| Config Value JSON | ConfigValueJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
...
| Last Updated By UPN | LastUpdatedByUpn | DateTime | Yes | No | No | No |  |
| Secret Reference Name | SecretReferenceName | Text | Yes | No | No | No | MaxLength=255 |
