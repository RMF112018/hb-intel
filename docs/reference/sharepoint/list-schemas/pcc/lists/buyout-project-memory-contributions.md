# PCC Buyout Project Memory Contributions

## 1. Objective
- Planned PCC schema/reference file for `PCC Buyout Project Memory Contributions`.
...
| Project Memory Contribution ID | ProjectMemoryContributionId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Kind | Kind | Choice | Yes | No | No | No |  |
| Narrative | Narrative | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Recorded At UTC | RecordedAtUtc | DateTime | Yes | No | No | No |  |
| Recorded By Person Ref | RecordedByPersonRef | Text | Yes | No | No | No | MaxLength=255 |
