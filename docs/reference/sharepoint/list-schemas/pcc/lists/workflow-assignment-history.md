# PCC Workflow Assignment History

## 1. Objective
- Planned PCC schema/reference file for `PCC Workflow Assignment History`.
...
| Assignment History ID | AssignmentHistoryId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Unassigned At UTC | UnassignedAtUtc | DateTime | Yes | No | No | No |  |
| Due Date UTC | DueDateUtc | DateTime | Yes | No | No | Yes | Indexed for query/view performance |
| Note | Note | Text | Yes | No | No | No | MaxLength=255 |
