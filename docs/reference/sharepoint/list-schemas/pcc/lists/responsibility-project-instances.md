# PCC Responsibility Project Instances

## 1. Objective
- Planned PCC schema/reference file for `PCC Responsibility Project Instances`.
...
| Assignment JSON | AssignmentJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Workflow Steps JSON | WorkflowStepsJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Handoffs JSON | HandoffsJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Evidence Links JSON | EvidenceLinksJson | Note | No | No | No | No | RichText=false; Lines=6 |
| Exceptions JSON | ExceptionsJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
