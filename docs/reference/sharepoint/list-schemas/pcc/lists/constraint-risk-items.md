# PCC Constraint Risk Items

## 1. Objective
- Planned PCC schema/reference file for `PCC Constraint Risk Items`.
...
| Item Number | ItemNumber | Number | Yes | No | No | No |  |
| Item Type | ItemType | Choice | Yes | No | No | No |  |
| Description | Description | Note | No | No | No | No | RichText=false; Lines=6 |
| Seed Category ID | SeedCategoryId | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| State | State | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| Responsible Party | ResponsibleParty | Text | Yes | No | No | No | MaxLength=255 |
| Ball In Court | BallInCourt | Text | Yes | No | No | No | MaxLength=255 |
| Date IDentified UTC | DateIdentifiedUtc | DateTime | Yes | No | No | No |  |
| Need By Date UTC | NeedByDateUtc | DateTime | Yes | No | No | No |  |
| Promised Date UTC | PromisedDateUtc | DateTime | Yes | No | No | No |  |
| Due Date UTC | DueDateUtc | DateTime | Yes | No | No | Yes | Indexed for query/view performance |
| Delivered Date UTC | DeliveredDateUtc | DateTime | Yes | No | No | No |  |
| Days Aging From IDentified | DaysAgingFromIdentified | DateTime | Yes | No | No | No |  |
| Mitigation Plan Summary | MitigationPlanSummary | Note | Yes | No | No | No | RichText=false; Lines=6 |
| External Party Reference | ExternalPartyReference | Text | No | No | No | No | MaxLength=255 |
| Converted To Constraint ID | ConvertedToConstraintId | Text | Yes | No | No | Yes | Indexed for query/view performance |
