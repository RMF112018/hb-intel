# PCC HBI Grounding Citations

## 1. Objective
- Planned PCC schema/reference file for `PCC HBI Grounding Citations`.
...
| Citation ID | CitationId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Project ID | ProjectId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Record Type | RecordType | Choice | Yes | No | No | No |  |
| Record ID | RecordId | Text | Yes | No | No | Yes | Indexed for query/view performance |
