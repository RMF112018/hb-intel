# PCC Site Health Checks

## 1. Objective
- Planned PCC schema/reference file for `PCC Site Health Checks`.
...
| Last Checked UTC | LastCheckedUtc | DateTime | Yes | No | No | No |  |
| Detail | Detail | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Repair Available | RepairAvailable | Boolean | Yes | No | No | No |  |
| Repair Tier | RepairTier | Text | Yes | No | No | No | MaxLength=255 |
| Check Category | CheckCategory | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| Expected Value | ExpectedValue | Number | No | No | No | No |  |
| Actual Value | ActualValue | Number | No | No | No | No |  |
