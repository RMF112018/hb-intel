...
## 1. Objective
- Planned PCC schema/reference file for `PCC External System Audit Events`.
...
| Audit Event ID | AuditEventId | Text | Yes | No | No | Yes | Indexed for query/view performance |
