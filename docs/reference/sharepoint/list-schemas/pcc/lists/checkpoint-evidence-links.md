...
## 1. Objective
- Planned PCC schema/reference file for `PCC Checkpoint Evidence Links`.
...
| Checkpoint Evidence Link ID | CheckpointEvidenceLinkId | Text | No | No | No | Yes | Indexed for query/view performance |
...
| Evidence Type | EvidenceType | Choice | No | No | No | No |  |
| Evidence Reference | EvidenceReference | Text | No | No | No | No | MaxLength=255 |
| Metadata JSON | MetadataJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
