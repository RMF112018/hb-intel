# PCC Project Lifecycle Events

## 1. Objective
- Planned PCC schema/reference file for `PCC Project Lifecycle Events`.
...
| Lifecycle Event ID | LifecycleEventId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Recorded By Persona | RecordedByPersona | Text | Yes | No | No | No | MaxLength=255 |
| Checkpoint ID | CheckpointId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Context References JSON | ContextReferencesJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
