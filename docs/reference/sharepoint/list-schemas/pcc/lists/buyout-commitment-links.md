# PCC Buyout Commitment Links

## 1. Objective
- Planned PCC schema/reference file for `PCC Buyout Commitment Links`.
...
| Commitment Link ID | CommitmentLinkId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Procore Commitment ID | ProcoreCommitmentId | Text | No | No | No | Yes | Indexed for query/view performance |
| Procore Commitment Number | ProcoreCommitmentNumber | Number | No | No | No | No |  |
| Procore Commitment Sov Line ID | ProcoreCommitmentSovLineId | Text | No | No | No | Yes | Indexed for query/view performance |
...
| Procore Original Commitment Amount | ProcoreOriginalCommitmentAmount | Number | No | No | No | No |  |
| Source Lineage ID | SourceLineageId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Reconciliation Status | ReconciliationStatus | Choice | Yes | No | No | Yes | Indexed for query/view performance |
