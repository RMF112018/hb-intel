# PCC Procore Curated Summaries

## 1. Objective
- Planned PCC schema/reference file for `PCC Procore Curated Summaries`.
...
| Curated Summary ID | CuratedSummaryId | Note | Yes | No | No | No | RichText=false; Lines=6 |
...
| Summary Text | SummaryText | Note | No | No | No | No | RichText=false; Lines=6 |
| Summarized Fields JSON | SummarizedFieldsJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
