# PCC Project Memory Records

## 1. Objective
- Planned PCC schema/reference file for `PCC Project Memory Records`.
...
| Memory ID | MemoryId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Project ID | ProjectId | Text | Yes | No | No | Yes | Indexed for query/view performance |
| Record Type | RecordType | Choice | Yes | No | No | No |  |
...
| Lifecycle Stage | LifecycleStage | Choice | Yes | No | No | No |  |
| Project Stage | ProjectStage | Choice | Yes | No | No | No |  |
| Recorded At UTC | RecordedAtUtc | DateTime | Yes | No | No | No |  |
| Author Persona | AuthorPersona | Text | Yes | No | No | No | MaxLength=255 |
| Ownership Posture | OwnershipPosture | Text | Yes | No | No | No | MaxLength=255 |
...
| Decision | Decision | Text | Yes | No | No | No | MaxLength=255 |
| Impact Statement | ImpactStatement | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| Assumption | Assumption | Text | Yes | No | No | No | MaxLength=255 |
| Validation Plan | ValidationPlan | Text | Yes | No | No | No | MaxLength=255 |
| Target Validation At UTC | TargetValidationAtUtc | DateTime | Yes | No | No | No |  |
