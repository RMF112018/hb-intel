# PCC Buyout Traceability Edge Contributions

## 1. Objective
- Planned PCC schema/reference file for `PCC Buyout Traceability Edge Contributions`.
...
| Traceability Edge Contribution ID | TraceabilityEdgeContributionId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| From Ref | FromRef | Text | Yes | No | No | No | MaxLength=255 |
| To Ref | ToRef | Text | Yes | No | No | No | MaxLength=255 |
| Edge Kind | EdgeKind | Choice | Yes | No | No | No |  |
