# PCC Project Module Registry

## 1. Objective
- Planned PCC schema/reference file for `PCC Project Module Registry`.
...
| Module Registry ID | ModuleRegistryId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Work Center ID | WorkCenterId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Mvp Tier | MvpTier | Text | Yes | No | No | No | MaxLength=255 |
| Module Posture | ModulePosture | Choice | Yes | No | No | No |  |
| Default Enabled | DefaultEnabled | Text | Yes | No | No | No | MaxLength=255 |
| Is Enabled | IsEnabled | Boolean | Yes | No | No | No |  |
| Visible By Project Stage | VisibleByProjectStage | Choice | Yes | No | No | No |  |
| Visible By Project Type | VisibleByProjectType | Choice | Yes | No | No | No |  |
| Primary Persona Keys JSON | PrimaryPersonaKeysJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
| Sort Order | SortOrder | Number | Yes | No | No | No |  |
| Config JSON | ConfigJson | Note | Yes | No | No | No | RichText=false; Lines=6 |
