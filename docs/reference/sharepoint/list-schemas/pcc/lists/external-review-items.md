...
## 1. Objective
- Planned PCC schema/reference file for `PCC External Review Items`.
...
| External Review Item ID | ExternalReviewItemId | Text | No | No | No | Yes | Indexed for query/view performance |
...
| Assigned Persona | AssignedPersona | Text | Yes | No | No | No | MaxLength=255 |
...
| Resolution Summary | ResolutionSummary | Note | Yes | No | No | No | RichText=false; Lines=6 |
