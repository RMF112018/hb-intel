# PCC Workflow Transitions

## 1. Objective
- Planned PCC schema/reference file for `PCC Workflow Transitions`.
...
| Workflow Transition ID | WorkflowTransitionId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| From Status | FromStatus | Choice | Yes | No | No | Yes | Indexed for query/view performance |
| To Status | ToStatus | Choice | Yes | No | No | Yes | Indexed for query/view performance |
