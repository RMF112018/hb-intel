# PCC Priority Action Suppressions

## 1. Objective
- Planned PCC schema/reference file for `PCC Priority Action Suppressions`.
...
| Suppression ID | SuppressionId | Text | Yes | No | No | Yes | Indexed for query/view performance |
...
| Suppressed By UPN | SuppressedByUpn | Text | Yes | No | No | No | MaxLength=255 |
| Suppressed At UTC | SuppressedAtUtc | DateTime | Yes | No | No | No |  |
| Suppression Reason | SuppressionReason | Note | No | No | No | No | RichText=false; Lines=6 |
| Expires At UTC | ExpiresAtUtc | DateTime | No | No | No | No |  |
