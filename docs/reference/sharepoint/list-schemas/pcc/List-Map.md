...
| 108 | PCC Module Flags                              | Global / HBCentral defaults; project overrides in Wave 16 settings family      | `model-derived-required`    | [`lists/module-flags.md`](lists/module-flags.md)                                                           |
