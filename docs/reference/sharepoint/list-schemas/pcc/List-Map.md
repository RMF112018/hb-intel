...
| 106 | PCC Configuration Registry | Global / HBCentral; project overrides where needed | `contract-derived-required` | [`lists/configuration-registry.md`](lists/configuration-registry.md) |
| 107 | PCC Feature Flags | Global / HBCentral | `model-derived-required` | [`lists/feature-flags.md`](lists/feature-flags.md) |
| 108 | PCC Module Flags | Global / HBCentral; project overrides where needed | `model-derived-required` | [`lists/module-flags.md`](lists/module-flags.md) |
