...
|--------|--------|------------------------|-------------------------|----------------|-------|---------|-------|
| leads | _pending_ | Leads List | _pending_ | List | Sales/BD Site | Lead/opportunity tracking | No dedicated schema artifact yet; pending P1-A1 field expansion |
| contracts | _pending_ | Contract Metadata List + Contract Library | _pending_ | Paired (List + Library) | Project Site | Contract documents with structured metadata | No dedicated schema artifact yet |
| pmp | _pending_ | PMP Index List + PMP Library | _pending_ | Paired (List + Library) | Project Site | Project management plan documents with structured index | No dedicated schema artifact yet |
