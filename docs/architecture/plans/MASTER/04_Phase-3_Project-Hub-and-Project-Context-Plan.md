...
- Supporting shared packages already exist at verified maturity levels:
  ...
  - `@hbc/features-project-hub` (v0.1.86, **active expansion** — SF21 health-pulse foundation plus contract-level implementations for Financial, Schedule, Constraints, Permits, Safety, Project Closeout, Project Startup, and Subcontract Execution Readiness are live; Project Warranty T10 Stages 1–5 implemented; P3-E15 Quality Control planning family authored and reconciled as implementation-ready architecture)
