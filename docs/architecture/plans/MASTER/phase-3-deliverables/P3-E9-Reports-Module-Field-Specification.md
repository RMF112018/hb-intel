...
**Status:** Refactored into T-file family — this file is the master index and reading guide. T01–T07 implementation complete in `@hbc/features-project-hub` v0.2.12.
