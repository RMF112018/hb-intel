...
| 6.1.9 | Report-candidate designation — at most one `isReportCandidate = true` per project; P3-F1 publication handoff handler implemented | In Progress | Stage 2 — Architecturally Defined | | P3-E4-T03 §3.6; P3-E4-T09 §16. Stub-ready via `promoteToPublished()` — B-FIN-03. No runtime persistence or handoff execution. |
