# 06 — Approval Handoff Panel

## Purpose
Panel showing Wave 14 approval ID, current step, assigned role, priority action, and status.
...
│ Panel showing Wave 14 approval ID, current step, assigned ... │
├────────────────────────────────────────────────────────────┤
