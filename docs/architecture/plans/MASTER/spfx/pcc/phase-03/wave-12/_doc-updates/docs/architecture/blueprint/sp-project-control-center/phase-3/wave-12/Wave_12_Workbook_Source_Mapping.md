...
| Workbook concept | Target architecture mapping |
|---|---|
| No # | source traceability ID; final system uses generated unique item IDs |
| Description | title/description |
| Date Identified | dateIdentified |
| Status | lifecycle status |
| Days Elapsed | calculated aging |
| Reference | evidence/reference links |
| Responsible | responsible company |
| B.I.C | ball-in-court owner |
| Due | need-by date |
| Completion Date | actual resolution date |
| Comments | comments/update history |
| Change Tracking | change-exposure linkage only |
| Delay Log | delay-exposure linkage only |
