...
| Team Snapshot               | Team & Access            | compact     | Three-lane lifecycle preview (Team Viewer, Permission Request, Access Manager) with preview-only assignment/approval/execution-status cues; no mutation or live execution.         |
