# Prompt 02 — Governing Docs and Register Alignment
...
Update governing PCC documentation to record Estimating Workbench as an MVP SharePoint/SPFx feature mounted under Project Readiness, with internal HB cost codes first, Commercial/Multifamily templates, and template-migration-only workbook import.

## Required Amendments

Update the blueprint, unified lifecycle, SoR matrix, standard project site contract, MVP scope register, workflow module register, phase roadmap, and module implementation plan. Use this package's documentation map.
