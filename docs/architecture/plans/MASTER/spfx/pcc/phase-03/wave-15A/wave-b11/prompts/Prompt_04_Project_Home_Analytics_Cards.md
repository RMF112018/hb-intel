# Prompt 04 — Project Home Analytics Cards
...
Add Project Home analytics cards and place them intelligently near related operational cards while preserving the Phase 06 first-fold choreography.
...
Implement analytics cards for the **Project Home** dashboard only.

Do not modify unrelated dashboards in this prompt.

## Required Analytics Cards

- **Action Exposure Mix** — related to Priority Actions; chart: donut or stacked horizontal bar; placement: near Priority Actions, early first or second fold.
- **Readiness / Approval Rollup** — related to Project Readiness, Approvals & Checkpoints, Missing Configurations; chart: grouped bar or progress bars; placement: near the readiness/approvals row.
- **Project Health Trend** — related to Site Health Summary; chart: line/area/sparkline; placement: near Site Health or immediately after the first operational row.
...
Do not place analytics ahead of the first six operational cards unless the chart directly supports that card cluster. The Action Exposure Mix may appear near Priority Actions if it improves visual depth without displacing Site Health or Document Control from the first row. Lifecycle/HBI/Procore detail content should remain below the first nine operational cards.
...
- the required analytics cards render on Project Home;
...
- Project Home dashboard includes the required MVP analytics cards.
