# Prompt 10 — Cost & Time Analytics Cards
...
Add Cost & Time analytics cards focused on schedule, procurement/buyout, and commitment/cost exposure preview.
...
Implement analytics cards for the **Cost & Time** dashboard only.

Do not modify unrelated dashboards in this prompt.

## Required Analytics Cards

- **Schedule Milestone Posture** — related to Schedule Monitor; chart: line / milestone bar; placement: near schedule card.
- **Procurement / Buyout Exposure** — related to Procurement & Buyout; chart: bar / waterfall-style bar; placement: near procurement/buyout.
- **Commitment / Cost Exposure Preview** — related to Commitment / Cost Exposure; chart: bar; placement: near cost exposure card.
...
Use current primary tab id `cost-time`. Do not imply live Sage, schedule, or cost integration. Use deterministic preview sample data and clear source authority copy.
...
- the required analytics cards render on Cost & Time;
...
- Cost & Time dashboard includes the required MVP analytics cards.
