# Prompt 05 — Documents Analytics Cards
...
Add analytics cards to the Documents dashboard near source/lane operational content.
...
Implement analytics cards for the **Documents / Document Control** dashboard only.

Do not modify unrelated dashboards in this prompt.

## Required Analytics Cards

- **Document Source Health Matrix** — related to document source cards; chart: stacked bar or matrix-style grid; placement: beside or immediately after source cards.
- **Document Readiness by Lane** — related to SharePoint, OneDrive, and external-system lanes; chart: grouped bar; placement: near lane cards.
- **Expiring / Stale / Missing Documents Preview** — related to document status/reference content; chart: bar or line; placement: after source posture cards.
...
Analytics must not obscure the three-lane Document Control boundary. Keep source-system launch/read-only/no-writeback cues visible. Use preview sample data where live document status data is unavailable.
...
- the required analytics cards render on Documents / Document Control;
...
- Documents / Document Control dashboard includes the required MVP analytics cards.
