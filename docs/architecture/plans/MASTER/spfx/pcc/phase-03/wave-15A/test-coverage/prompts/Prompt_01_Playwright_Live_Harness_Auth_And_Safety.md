# Playwright Live Harness, Auth, and Safety
...
Add `playwright.pcc-live.config.ts`, `e2e/pcc-live/README.md`, `pcc-live.env.ts`, root scripts, and .gitignore protection. Implement self-skip behavior for missing env/storage state. Follow the live SharePoint no-webServer pattern. Add optional Brave executable support only as a secondary project.
