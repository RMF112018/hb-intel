# Prompt 09 — Project Controls Analytics Cards
...
Add Project Controls analytics cards focused on constraints aging, permit/inspection readiness, and risk/issue severity distribution.
...
Implement analytics cards for the **Project Controls** dashboard only.

Do not modify unrelated dashboards in this prompt.

## Required Analytics Cards

- **Constraints Aging** — related to Constraints Log; chart: histogram / stacked bar; placement: near Constraints Log.
- **Permit / Inspection Readiness** — related to Permits & Inspections; chart: grouped bar; placement: near permits/inspections.
- **Risk / Issue Severity Distribution** — related to Risk / Issues / Decisions; chart: donut or stacked bar; placement: near risk/issues cards.
...
Use current primary tab id `project-controls`. Constraints and permit/inspection analytics should be prominent because they support active execution. Use preview sample data where needed.
...
- the required analytics cards render on Project Controls;
...
- Project Controls dashboard includes the required MVP analytics cards.
