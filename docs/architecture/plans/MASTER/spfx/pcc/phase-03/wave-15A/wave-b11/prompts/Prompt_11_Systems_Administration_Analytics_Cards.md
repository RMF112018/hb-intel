# Prompt 11 — Systems Administration Analytics Cards
...
Add Systems Administration analytics cards focused on integration health, configuration severity, and Procore mapping/sync posture.
...
Implement analytics cards for the **Systems Administration** dashboard only.

Do not modify unrelated dashboards in this prompt.

## Required Analytics Cards

- **Integration Health Summary** — related to Integration Settings / External Systems; chart: donut or stacked bar; placement: near integration settings.
- **Configuration Severity** — related to Module Configuration / Control Center Settings; chart: stacked bar; placement: near configuration cards.
- **Procore Mapping / Sync Posture** — related to Procore Mapping / Sync Health; chart: gauge-like status bar or grouped bar; placement: near Procore mapping card.
...
Use current primary tab id `systems-administration`. Do not imply live repair execution, tenant mutation, Procore writeback, or live sync.
...
- the required analytics cards render on Systems Administration;
...
- Systems Administration dashboard includes the required MVP analytics cards.
