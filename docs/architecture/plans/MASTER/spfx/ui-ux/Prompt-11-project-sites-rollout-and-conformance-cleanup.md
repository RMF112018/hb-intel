# Prompt 11 — Project Sites Rollout And Conformance Cleanup

## Objective

Apply the conformed shared shell/layout/component patterns to the verified project-sites package source app and eliminate unjustified drift.
...
1. Use the verified package provenance mapping to target the correct project-sites source app.
...
3. Preserve project-sites-specific behavior and host integration.
4. Update tests and package-specific docs as needed.
5. Record any remaining governed exceptions and why they are legitimate.

## Deliverables

- project-sites source app updated to consume the canonical shared patterns
...
- the project-sites experience is visibly aligned with suite-wide patterns
- site-specific domain behavior remains intact
- no new parallel UI layer is introduced
- the app still builds and packages through the verified project-sites flow
