...
This prompt should complete the queue/detail workflow that is actually missing, not re-litigate ownership or redesign lifecycle semantics.
...
- Add or update tests to cover the completed queue/detail behavior.
