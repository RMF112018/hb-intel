...
- Do not add a new explicit controller launch button unless Phase 2 deliberately changed the backend contract to require one.
...
4. Are the current status banners, toasts, labels, and action names still semantically correct under the auto-trigger model?
5. Do the current `/project-review` routes still represent the right controller workflow surface?
6. What exact Phase 3 frontend work is required, and what is intentionally not part of Phase 2?
...
- no PH6-era launch wording is silently reintroduced
