...
Audit the live repo, reconcile the current People & Culture implementation against the locked product decisions, and establish the exact implementation target state before changing runtime behavior.
...
- Do not preserve the current merged People & Culture / Kudos architecture as the end-state.
...
1. Confirm the current People & Culture / HB Kudos file ownership model.
...
3. Freeze the target end-state structure for:
   ...
   - HB Kudos public webpart boundary
   - People & Culture HR operating companion webpart
4. Produce the exact file move/create/update/delete plan required before or during implementation.

## Instructions for the Agent

1. Inspect the current People & Culture and adjacent split-related source paths.
2. Document which existing components remain viable and which are transitional only.
3. Explicitly confirm that:
   - People & Culture remains the communication / culture surface
   - HB Kudos remains the recognition product surface
   - the People & Culture HR companion becomes a separate operating/governance surface
