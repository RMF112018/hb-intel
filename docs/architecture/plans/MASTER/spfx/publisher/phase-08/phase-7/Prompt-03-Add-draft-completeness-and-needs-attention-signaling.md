# Prompt 03 Add draft completeness and needs attention signaling
...
> implement completeness and attention-state indicators so authors can quickly identify incomplete drafts and blocking issues from the queue
...
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-g-queue-and-draft-management-improvements/step-03/`
