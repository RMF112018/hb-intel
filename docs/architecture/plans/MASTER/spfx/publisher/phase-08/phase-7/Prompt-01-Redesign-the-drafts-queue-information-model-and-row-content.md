# Prompt 01 Redesign the drafts queue information model and row content

You are working in the live local HB Intel repo.

Objective:
Execute the required work for **Workstream G — Queue and Draft-Management Improvements**.
For this step, your specific objective is to:

> define the future-state draft queue information model, including search, friendly metadata, draft completeness cues, and stronger row hierarchy
...
- `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-g-queue-and-draft-management-improvements/`
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-g-queue-and-draft-management-improvements/step-01/`
