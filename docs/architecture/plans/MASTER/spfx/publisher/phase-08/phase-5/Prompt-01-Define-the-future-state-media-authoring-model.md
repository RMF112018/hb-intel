# Prompt 01 Define the future state media authoring model

You are working in the live local HB Intel repo.

Objective:
Execute the required work for **Workstream E — Media and Gallery Redesign**.
For this step, your specific objective is to:

> design the target media and gallery authoring model, including role selection, thumbnail treatment, caption/alt-text guidance, and ordering behavior
...
- `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-e-media-and-gallery-redesign/`
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-e-media-and-gallery-redesign/step-01/`
