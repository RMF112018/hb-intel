# Prompt 04 Replace the current tab first admin IA with editorial IA
...
> replace the current raw tab-first information architecture with an editorial task-oriented IA and ensure the UI no longer reads as a CRUD admin console
...
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-a-product-architecture-and-ux-redesign/step-04/`
