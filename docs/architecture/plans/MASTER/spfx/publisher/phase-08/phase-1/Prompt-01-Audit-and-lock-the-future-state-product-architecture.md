# Prompt 01 Audit and lock the future state product architecture

You are working in the live local HB Intel repo.

Objective:
Execute the required work for **Workstream A — Product Architecture and UX Redesign**.
For this step, your specific objective is to:

> audit the current Publisher implementation, confirm the actual runtime seams, and lock the future-state product architecture, page information architecture, and section model for the redesigned editorial workspace
...
- `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-a-product-architecture-and-ux-redesign/`
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-a-product-architecture-and-ux-redesign/step-01/`
