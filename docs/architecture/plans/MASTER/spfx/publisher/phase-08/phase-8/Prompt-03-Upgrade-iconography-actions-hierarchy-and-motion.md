# Prompt 03 Upgrade iconography actions hierarchy and motion
...
> introduce real premium iconography, better action affordances, stronger hierarchy, and restrained motion using the approved premium stack where justified
...
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-h-visual-system-and-doctrine-conformance/step-03/`
