# Prompt 02 Migrate the publisher surface to token led styling and governed primitives
...
> reduce hardcoded styling and move the Publisher onto token-led styling, shared primitives, and reusable visual variants
...
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-h-visual-system-and-doctrine-conformance/step-02/`
