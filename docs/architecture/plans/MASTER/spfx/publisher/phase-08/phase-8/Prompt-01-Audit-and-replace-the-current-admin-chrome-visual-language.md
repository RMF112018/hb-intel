# Prompt 01 Audit and replace the current admin chrome visual language

You are working in the live local HB Intel repo.

Objective:
Execute the required work for **Workstream H — Visual System and Doctrine Conformance**.
For this step, your specific objective is to:

> audit the current Publisher visual language against doctrine and replace the existing admin-chrome styling posture with a premium editorial product language
...
- `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-h-visual-system-and-doctrine-conformance/`
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-h-visual-system-and-doctrine-conformance/step-01/`
