# Prompt 01 Redesign preview and readiness information architecture
...
> define the future-state separation between Article Preview and Publish Readiness, including what belongs in each surface and how technical detail is presented
...
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-f-preview-and-publish-readiness-split/step-01/`
