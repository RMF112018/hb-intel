# Prompt 01 Design the team authoring flow using kudos composer patterns
...
> define the final interaction model for team authoring using the Kudos flyout pattern and the governed HbcPeoplePicker as the benchmark
...
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-d-team-authoring-redesign/step-01/`
