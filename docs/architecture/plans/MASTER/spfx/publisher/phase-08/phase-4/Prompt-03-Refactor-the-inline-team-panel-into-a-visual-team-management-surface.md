# Prompt 03 Refactor the inline team panel into a visual team management surface

You are working in the live local HB Intel repo.

Objective:
Execute the required work for **Workstream D — Team Authoring Redesign**.
For this step, your specific objective is to:

> replace the raw row-card editor with a cleaner visual team management surface that supports edit, reorder, remove, and featured-state control
...
- `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-d-team-authoring-redesign/`
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-d-team-authoring-redesign/step-03/`
