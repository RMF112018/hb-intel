# Prompt 02 Implement team member flyout with hbcPeoplePicker and hydration
...
> build the Add Team Member flyout, wire HbcPeoplePicker, and hydrate team member data from person selection instead of blank manual entry
...
- Save this step's closure evidence under: `docs/architecture/plans/MASTER/spfx/publisher/remediation/workstream-d-team-authoring-redesign/step-02/`
