    # Prompt 03 — Convert validation into a publish-readiness system

    ## Objective

    Execute **Wave 2 — Upgrade the core editorial experience / Step 03** for the Article Publisher remediation program.

    Step goal:
    Turn the strong underlying validation engine into an operator-friendly readiness experience with grouped blockers, warnings, guidance, and field-jump affordances.
...
- apps/hb-webparts/src/webparts/articlePublisher/ArticlePublisher.tsx
    ...
    - Readiness panel or rail with blockers, warnings, and remediation guidance.
- Friendly validation language for authors.
- Publish gating that is understandable without reading system jargon.

    ## Acceptance criteria

    - Blocked publish states are easy to understand and fix.
- Validation findings are grouped and actionable.
- The surface increases author confidence instead of feeling merely restrictive.
