    # Prompt 05 — Improve media authoring experience

    ## Objective

    Execute **Wave 2 — Upgrade the core editorial experience / Step 05** for the Article Publisher remediation program.

    Step goal:
    Reduce media-management friction by improving asset selection, verification, sequencing, and accessibility guidance.
...
- apps/hb-webparts/src/homepage/data/publisherAdapter/validation/validationEngine.ts
    ...
    - Friendlier banner/gallery asset workflows than raw URL entry alone.
- Image previews/thumbnails where appropriate.
- Better alt-text guidance and gallery sequencing UX.

    ## Acceptance criteria

    - Media authoring is noticeably less manual and less error-prone.
- Authors can visually verify media before publish.
- Accessibility guidance around alt text is improved without creating unnecessary burden.
