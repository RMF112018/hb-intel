    # Wave 2 — Upgrade the core editorial experience — README

    ## Package purpose

    This package contains the executable prompt set for **Wave 2 — Upgrade the core editorial experience** in the Article Publisher remediation program.
...
- When you finish a prompt, create a closure note in the same wave folder documenting what changed, what was validated, and any residual risk.
    ...
    - 1. Prompt-01-replace-body-textarea-with-rich-text-editor.md
- 2. Prompt-02-recompose-the-authoring-workspace.md
- 3. Prompt-03-convert-validation-into-publish-readiness.md
- 4. Prompt-04-build-a-visual-author-confidence-preview.md
- 5. Prompt-05-improve-media-authoring-experience.md
