    # Wave 0 — Stabilize hosted truth and eliminate visible drift — README

    ## Package purpose

    This package contains the executable prompt set for **Wave 0 — Stabilize hosted truth and eliminate visible drift** in the Article Publisher remediation program.
...
- When you finish a prompt, create a closure note in the same wave folder documenting what changed, what was validated, and any residual risk.
    ...
    - 1. Prompt-01-close-hosted-list-runtime-drift.md
- 2. Prompt-02-close-visible-naming-and-branding-drift.md
- 3. Prompt-03-perform-wave-0-hosted-validation.md
