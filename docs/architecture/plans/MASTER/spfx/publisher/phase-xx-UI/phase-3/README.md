    # Wave 3 — Product hardening, doctrine alignment, and maintainability — README

    ## Package purpose

    This package contains the executable prompt set for **Wave 3 — Product hardening, doctrine alignment, and maintainability** in the Article Publisher remediation program.
...
- When you finish a prompt, create a closure note in the same wave folder documenting what changed, what was validated, and any residual risk.
    ...
    - 1. Prompt-01-refactor-article-publisher-into-product-grade-seams.md
- 2. Prompt-02-realign-styling-with-ui-doctrine.md
- 3. Prompt-03-harden-accessibility-and-keyboard-flows.md
- 4. Prompt-04-prepare-for-future-destination-expansion.md
