...
- [ ] `packages/versioned-record/README.md` written (see Package README section below)
- [ ] `docs/README.md` ADR index updated with ADR-0015 entry (see ADR Index Update section below)
...
Package README created: packages/versioned-record/README.md  (implementation-time deliverable — see T09 Package README section)
docs/README.md ADR index updated: ADR-0015 row appended  (implementation-time deliverable — see T09 ADR Index Update section)
...
**File:** `packages/versioned-record/README.md`

Create this file as part of the T09 implementation deliverables. It is the primary developer-facing entry point for anyone consuming `@hbc/versioned-record` from the monorepo.
...
**Locked ADR:** ADR-0015 — `docs/architecture/adr/0015-versioned-record-platform-primitive.md`
...
- `docs/architecture/adr/0015-versioned-record-platform-primitive.md` — Locked ADR
````
...
```markdown
| [ADR-0015](architecture/adr/0015-versioned-record-platform-primitive.md) | `@hbc/versioned-record` as Platform Primitive | Accepted | 2026-03-08 |
```
...
# 13. Package README exists
test -f packages/versioned-record/README.md && echo "README OK" || echo "README MISSING"
