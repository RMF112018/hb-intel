**HB-Intel — Phase 4B: Post-Audit Remediation & Production Readiness Plan Completion Task 4B.16**  
...
## 7. Phase 4b.16 — Developer Harness, Documentation & E2E Expansion (P3)

**Effort:** 10 hours  
**Owner:** QA Engineer  
**Acceptance Criteria:**

- Dev-harness gains `DemoShell`, `DemoNavigation`, `DemoLayouts` pages.  
- Each domain app (accounting, estimating, etc.) has at least one smoke e2e spec verifying `WorkspacePageShell`.  
- All missing component reference docs in `docs/reference/ui-kit/` completed.  
- `CLAUDE.md` and `DESIGN_SYSTEM.md` updated with final dual-entry-point guidance.

**Implementation Steps:**

- Add the three missing demo pages to `apps/dev-harness/src/pages/`.  
- Create one Playwright smoke spec per domain app.  
- Complete all component reference Markdown files.  
