...
| Phase 3 Wave 2 — PCC Shell Frame and UI/UX                        | Active/in-progress wave. Prompt 02 scaffolded `apps/project-control-center/`; later Wave 2 prompts continue fixture-driven preview shell/frame/surface implementation. No live backend/provisioning/tenant/Graph/PnP/Procore/runtime/deployment behavior has been introduced. | `docs/architecture/plans/MASTER/spfx/pcc/phase-03/wave-02/` |
...
| Wave 2 SPFx PCC shell target                                                             | `apps/project-control-center/` (locked target; scaffold exists) |
...
| SPFx PCC shell                                         | Wave 2 target locked to `apps/project-control-center/`; scaffold exists and Wave 2 preview implementation is in progress |
...
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| Shell target path          | `apps/project-control-center/` is the locked target location (scaffold exists).                                                                       |
...
Recommended next implementation sequencing:

1. Continue the Phase 3 Wave 2 prompt sequence.
2. Keep Prompt 06 bounded to preview-only Document Control / External Systems / Site Health frames.
3. Keep live operations deferred (no live backend/provisioning/tenant/Graph/PnP/Procore/runtime/deployment behavior).
