...
- provide unified access to project files across SharePoint Drive, OneDrive, and Procore.

Behavior:

- launch/open file source;
- label source of record;
- respect permissions;
- provide access issue prompt;
- do not manage document review/routing.
...
| 7 | Document Control Center access hub UI. |
