...
Settings table with Setting, Category, Effective Value, Source, Owner, Validation, Approval, Last Updated, Actions.
...
│ Settings table with Setting, Category, Effective Value, So... │
├────────────────────────────────────────────────────────────┤
