# 05 — Change Request Drawer

## Purpose

Drawer for proposed value, justification, effective date, approval route, validation, submit/save draft.
...
│ Drawer for proposed value, justification, effective date, ... │
├────────────────────────────────────────────────────────────┤
