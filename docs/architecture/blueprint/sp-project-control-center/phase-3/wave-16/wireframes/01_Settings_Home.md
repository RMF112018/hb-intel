...
Overview-first settings landing page with health summary, pending requests, missing config, category cards, and recent changes.
...
│ Overview-first settings landing page with health summary, ... │
├────────────────────────────────────────────────────────────┤
