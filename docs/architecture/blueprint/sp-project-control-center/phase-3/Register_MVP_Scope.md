...
| Document Control Center | Unified access hub for SharePoint Drive, OneDrive, and Procore files. Not a document-control management module. |
...
| Document management workflows | Only if later approved; MVP is access hub only. |
