...
| Phase 5 — HB Document Control Center MVP                            | P1       | High           | Phase 3              | Medium | Medium     | SPFx Engineering              | Project Document Source Registry model; Graph posture                                                                 | Three-lane delivery: Project Record (formal SharePoint record), My Project Files (project-scoped OneDrive working files), and External Systems (launch/deep-link/visibility). Includes project-only My Project Files guardrail, source binding, role/action policy, and planning-grade review/audit posture.                                                                                                                                                                                      |
...
### Phase 6 Wave 8 Scope Lock (Documentation Definition)
