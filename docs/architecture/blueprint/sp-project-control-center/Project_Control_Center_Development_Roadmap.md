...
| SPFx PCC shell | Wave 2 shell target locked at `apps/project-control-center/` | Target location is locked; app is not yet created in repo truth. |
...
| Wave 2 shell target path | SPFx shell implementation location | SPFx Engineering | Locked to `apps/project-control-center/` (currently absent) |
...
`apps/project-control-center/` (locked Wave 2 target location; currently absent in repo truth).
