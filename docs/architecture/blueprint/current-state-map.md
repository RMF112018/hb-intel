...
| SF22 shared-feature plans (10 files: `SF22-Post-Bid-Learning-Loop.md` through `SF22-T09-Testing-and-Deployment.md`) | **Canonical Normative Plan** | Tier 2 — matrix classification only; `@hbc/post-bid-autopsy` planning family authored 2026-03-12; T01-T06 now cover primitive scaffold/contracts/lifecycle/hooks plus BD adapter wizard/summary/list/dashboard UI surfaces and Estimating wizard/summary/list UI surfaces while preserving published learning-signal compatibility |
