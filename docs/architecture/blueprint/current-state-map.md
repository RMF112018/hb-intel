...
| SF24 shared-feature plans (10 files: `SF24-Export-Runtime.md` through `SF24-T09-Testing-and-Deployment.md`) | **Canonical Normative Plan** | Phase 3 Stage 5.2; T01 scaffold complete 2026-03-23; package `@hbc/export-runtime` v0.0.1 scaffolded |
...
| `packages/export-runtime` | @hbc/export-runtime | Shared export runtime — lifecycle, render pipeline, receipt state, provenance, offline replay | Depends on models, ui-kit; peer: react, react-dom, @tanstack/react-query | v0.0.6 | `packages/export-runtime/README.md` |
