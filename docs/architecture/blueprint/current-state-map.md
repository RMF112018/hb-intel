...
| 4 | [ADRs](./adr/) (100 active; 6 archived — see §2.2 for resolution record) | Permanent Decision Rationale | Append-only | Individual architectural decisions |
...
| `docs/architecture/adr/` (all files) | **Permanent Decision Rationale** | Exempt from inline banner; 100 active records indexed; 6 archived in `adr/archived/`; conflicts resolved PH7.11 |
