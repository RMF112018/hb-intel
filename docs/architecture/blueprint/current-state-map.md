...
| SF19 shared-feature plans (10 files: `SF19-BD-Score-Benchmark.md` through `SF19-T09-Testing-and-Deployment.md`) | **Canonical Normative Plan** | Tier 2 — matrix classification only; `@hbc/features-business-development` score-benchmark planning family authored 2026-03-11; ADR-0108 reserved; pending PH7.12 sign-off (ADR-0090) before implementation |
