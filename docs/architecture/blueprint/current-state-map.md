...
| `plans/PH7-Breakout-Webparts-Plan.md` | **Canonical Normative Plan** | Tier 1 banner applied 2026-03-14; master infrastructure summary for `ph7-breakout-webparts/` task files; pending PH7.12 sign-off |
| `plans/PH7-BD-Features.md` | **Canonical Normative Plan** | Tier 1 banner applied 2026-03-14; master summary and locked-decisions index for `ph7-business-development/` task files; pending PH7.12 sign-off |
| `plans/PH7-Estimating-Features.md` | **Canonical Normative Plan** | Tier 1 banner applied 2026-03-14; v2.0 master summary for `ph7-estimating/` task files; supersedes `PH7-Estimating-Feature-Plan.md` v1.0; pending PH7.12 sign-off |
...
| `plans/MVP/MVP-Project-Setup-Plan.md` and `MVP-Project-Setup-T01` through `T09` (10 files) | **Canonical Normative Plan** | Tier 2 — matrix classification only; MVP Project Setup master plan + task files; pending refinement per MVP-Plan-Review; ADR-0090 required before implementation |
...
| `apps/estimating/src/components/project-setup/` | **Canonical Current-State** | Estimating requester guided setup surface components; step body renderers, resume banner, state display helpers, request detail compositions (core summary, state context, clarification banner); produced by W0-G4-T01 |
