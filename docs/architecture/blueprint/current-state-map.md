...
| SF22 shared-feature plans (10 files: `SF22-Post-Bid-Learning-Loop.md` through `SF22-T09-Testing-and-Deployment.md`) | **Canonical Normative Plan** | Tier 2 — matrix classification only; `@hbc/post-bid-autopsy` planning family authored 2026-03-12; T01 scaffold expands the primitive boundary for evidence/confidence/taxonomy/governance/publication/telemetry while preserving published learning-signal compatibility |
...
| `packages/post-bid-autopsy` | @hbc/post-bid-autopsy | Tier-1 post-bid autopsy scaffold primitive for evidence, confidence, taxonomy, governance, publication, telemetry, and published learning-signal contracts | None (scaffold primitive) | v0.0.1 | `packages/post-bid-autopsy/README.md` |
