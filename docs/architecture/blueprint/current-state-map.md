...
| Phase 5 admin plans (3 canonical docs under `phase-05/`) | **Canonical Current-State** | Operator-console baseline, route taxonomy (8-lane model), page ownership map; lane registry at `apps/admin/src/router/lane-registry.ts`; in progress 2026-04-03 |
