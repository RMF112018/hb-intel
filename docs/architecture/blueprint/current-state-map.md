...
| `packages/bulk-actions` | @hbc/bulk-actions | Shared bulk-actions — selection semantics, eligibility, chunked execution, mixed-result reporting | Depends on models; peer: react, react-dom, @tanstack/react-query | v0.0.4 | `packages/bulk-actions/README.md` |
