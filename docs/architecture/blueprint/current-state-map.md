...
| `packages/export-runtime` | @hbc/export-runtime | Shared export runtime — lifecycle, render pipeline, receipt state, provenance, offline replay | Depends on models, ui-kit; peer: react, react-dom, @tanstack/react-query | v0.0.8 | `packages/export-runtime/README.md` |
