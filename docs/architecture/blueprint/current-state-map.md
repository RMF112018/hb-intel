...
| Phase 6 admin plans (1 canonical doc under `phase-06/`) | **Canonical Current-State** | Prerequisite audit — existing substrate inventory, true blockers, compatibility strategy, 10-prompt execution sequence; in progress 2026-04-03 |
