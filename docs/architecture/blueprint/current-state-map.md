...
| `packages/publish-workflow` | @hbc/publish-workflow | Shared publication workflow — state machine, readiness/approval, supersession/revocation, receipt traceability | Depends on models; peer: react, react-dom, @tanstack/react-query | v0.0.2 | `packages/publish-workflow/README.md` |
