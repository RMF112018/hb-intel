...
| `packages/export-runtime` | @hbc/export-runtime | Shared export runtime — lifecycle, render pipeline, receipt state, provenance, offline replay | Depends on models; peer: react, react-dom, @tanstack/react-query | v0.0.2 | `packages/export-runtime/README.md` |
