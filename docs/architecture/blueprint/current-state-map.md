...
| SF11 shared-feature plans (10 files: `SF11-Smart-Empty-State.md` through `SF11-T09-Testing-and-Deployment.md`) | **Canonical Normative Plan** | Tier 2 — matrix classification only; `@hbc/smart-empty-state` planning family authored 2026-03-10; ADR-0100 reserved; pending PH7.12 sign-off (ADR-0090) before implementation |
| `docs/architecture/adr/ADR-0100-smart-empty-state-platform-primitive.md` | **Permanent Decision Rationale** | SF11 smart-empty-state platform primitive; 10 locked decisions (D-01–D-10); to be authored when SF11 enters active development |
| SF12 shared-feature plans (10 files: `SF12-Session-State.md` through `SF12-T09-Testing-and-Deployment.md`) | **Canonical Normative Plan** | Tier 2 — matrix classification only; `@hbc/session-state` planning family authored 2026-03-10; ADR-0101 reserved; pending PH7.12 sign-off (ADR-0090) before implementation |
| `docs/architecture/adr/ADR-0101-session-state-offline-persistence.md` | **Permanent Decision Rationale** | SF12 session-state offline persistence primitive; 10 locked decisions (D-01–D-10); to be authored when SF12 enters active development |
...
| SF17 shared-feature plans (10 files: `SF17-Admin-Intelligence.md` through `SF17-T09-Testing-and-Deployment.md`) | **Canonical Normative Plan** | Tier 2 — matrix classification only; `@hbc/features-admin` admin-intelligence planning family authored 2026-03-11; ADR-0106 reserved; pending PH7.12 sign-off (ADR-0090) before implementation |
| `docs/architecture/adr/ADR-0106-admin-intelligence-layer.md` | **Permanent Decision Rationale** | SF17 admin-intelligence layer primitive; 10 locked decisions (D-01–D-10); to be authored when SF17 enters active development |
| SF18 shared-feature plans (10 files: `SF18-Estimating-Bid-Readiness.md` through `SF18-T09-Testing-and-Deployment.md`) | **Canonical Normative Plan** | Tier 2 — matrix classification only; `@hbc/features-estimating` bid-readiness planning family authored 2026-03-11; ADR-0107 reserved; pending PH7.12 sign-off (ADR-0090) before implementation |
| `docs/architecture/adr/ADR-0107-estimating-bid-readiness-signal.md` | **Permanent Decision Rationale** | SF18 estimating bid-readiness signal primitive; 10 locked decisions (D-01–D-10); to be authored when SF18 enters active development |
