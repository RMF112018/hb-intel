...
| Phase 6 admin plans (4 canonical docs under `phase-06/`) | **Canonical Current-State** | Prerequisite audit, install/bootstrap architecture, step model (6 families, 9 install steps), manual checkpoint policy; in progress 2026-04-03 |
