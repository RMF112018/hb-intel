...
| Phase 5 admin plans (4 canonical docs under `phase-05/`) | **Canonical Current-State** | Operator-console baseline, route taxonomy (8-lane model), page ownership map, rehoming decisions; 8-lane shell live with 3 active lanes (Runs, Config, Health), 4 scaffold lanes, operator landing page, 3 legacy redirects; lane registry at `apps/admin/src/router/lane-registry.ts`; in progress 2026-04-03 |
