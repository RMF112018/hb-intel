...
| `packages/saved-views` | @hbc/saved-views | Shared workspace-state persistence — view lifecycle, scope model, schema compatibility, reconciliation | Depends on models; peer: react, react-dom, @tanstack/react-query | v0.0.3 | `packages/saved-views/README.md` |
