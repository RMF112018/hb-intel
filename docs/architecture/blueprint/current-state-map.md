...
| `packages/record-form` | @hbc/record-form | Shared record authoring runtime — create/edit/duplicate/template lifecycle, draft recovery, review handoff, offline replay | Depends on models; peer: react, react-dom, @tanstack/react-query | v0.0.2 | `packages/record-form/README.md` |
