...
| `packages/bulk-actions` | @hbc/bulk-actions | Shared bulk-actions — selection semantics, eligibility, chunked execution, mixed-result reporting | Depends on models, ui-kit; peer: react, react-dom, @tanstack/react-query | v0.0.7 | `packages/bulk-actions/README.md` |
