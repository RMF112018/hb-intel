...
export const LEGACY_FALLBACK_REGISTRY_LIST_DESCRIPTOR: IListDefinition = {
  ...
  fields: [
    ...
    { internalName: 'leadEstimatorUpns', displayName: 'Lead Estimator Upns', type: 'MultiLineText' },
    { internalName: 'estimatorUpns', displayName: 'Estimator Upns', type: 'MultiLineText' },
    { internalName: 'idsManagerUpns', displayName: 'Ids Manager Upns', type: 'MultiLineText' },
    { internalName: 'projectAccountantUpns', displayName: 'Project Accountant Upns', type: 'MultiLineText' },
    { internalName: 'projectAdministratorUpns', displayName: 'Project Administrator Upns', type: 'MultiLineText' },
    { internalName: 'projectCoordinatorUpns', displayName: 'Project Coordinator Upns', type: 'MultiLineText' },
    { internalName: 'superintendentUpns', displayName: 'Superintendent Upns', type: 'MultiLineText' },
    { internalName: 'leadSuperintendentUpns', displayName: 'Lead Superintendent Upns', type: 'MultiLineText' },
    { internalName: 'projectManagerUpns', displayName: 'Project Manager Upns', type: 'MultiLineText' },
    { internalName: 'leadProjectManagerUpns', displayName: 'Lead Project Manager Upns', type: 'MultiLineText' },
    { internalName: 'projectExecutiveUpns', displayName: 'Project Executive Upns', type: 'MultiLineText' },
    { internalName: 'safetyCoordinatorUpns', displayName: 'Safety Coordinator Upns', type: 'MultiLineText' },
    { internalName: 'qcManagerUpns', displayName: 'Qc Manager Upns', type: 'MultiLineText' },
    { internalName: 'warrantyManagerUpns', displayName: 'Warranty Manager Upns', type: 'MultiLineText' },
