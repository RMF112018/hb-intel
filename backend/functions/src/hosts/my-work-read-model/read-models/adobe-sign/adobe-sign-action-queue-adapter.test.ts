      ...
      expect(events).toEqual([
        {
          ...
          properties: {
            ...
            searchMethod: 'POST',
            searchBodyTopLevelKeyCount: 2,
            searchHasScopeField: true,
            searchScopeAgreementAssetsCount: 1,
            searchHasAgreementAssetsCriteriaField: true,
            searchAgreementAssetsCriteriaHasPageSizeField: true,
            searchAgreementAssetsCriteriaHasStartIndexField: true,
            searchAgreementAssetsCriteriaHasStatusField: false,
            searchAgreementAssetsCriteriaHasRoleField: false,
            searchAgreementAssetsCriteriaHasTypeField: false,
            searchHasMatchingFiltersInfoField: false,
            searchHasAgreementOriginInfoField: false,
            searchHasRecipientStatusFilterField: false,
            searchHasPageSizeField: false,
            searchHasCursorField: false,
            searchApprovedStatusCount: 0,
            searchMalformedBodyWasJsonObject: true,
            searchMalformedTopLevelKeyCount: 2,
            ...
            searchMalformedHasPageField: true,
            searchMalformedPageWasObject: true,
            searchMalformedPageHasNextCursorField: true,
            searchMalformedHasUserAgreementListField: true,
            searchMalformedHasUserAgreementListArray: true,
            searchMalformedUserAgreementListHasAtLeastOneItem: true,
            searchMalformedFirstUserAgreementWasObject: true,
            searchMalformedFirstUserAgreementHasIdField: true,
            searchMalformedFirstUserAgreementHasNameField: true,
            searchMalformedFirstUserAgreementHasStatusField: true,
            searchMalformedFirstUserAgreementHasRecipientStatusField: false,
            searchMalformedHasAgreementAssetsField: true,
            searchMalformedHasAgreementAssetsArray: true,
            searchMalformedHasResultsField: false,
            searchMalformedHasResultsArray: false,
            searchMalformedHasSearchResultsField: false,
            searchMalformedHasSearchResultsArray: false,
            searchMalformedHasResultListField: false,
            searchMalformedHasResultListArray: false,
            searchMalformedHasPageInfoField: false,
            searchMalformedHasTotalCountField: true,
            searchMalformedHasCurrentPageField: false,
            searchMalformedHasTotalPagesField: false,
            searchMalformedHasAgreementAssetListField: false,
            searchMalformedHasAgreementAssetListArray: false,
            searchMalformedHasAgreementAssetsListField: false,
            searchMalformedHasAgreementAssetsListArray: false,
            searchMalformedHasAgreementAssetSearchResultsField: false,
            searchMalformedHasAgreementAssetSearchResultsArray: false,
            searchMalformedHasAgreementAssetSearchResultListField: true,
            searchMalformedHasAgreementAssetSearchResultListArray: true,
            searchMalformedHasSearchResultField: true,
            searchMalformedSearchResultWasObject: true,
            searchMalformedSearchResultHasAgreementAssetsField: true,
            searchMalformedSearchResultHasAgreementAssetsArray: true,
            searchMalformedHasPagingInfoField: false,
            searchMalformedHasPaginationField: true,
            searchMalformedHasPageDataField: false,
            searchMalformedHasTotalHitsField: false,
