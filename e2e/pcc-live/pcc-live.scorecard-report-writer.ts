...
export async function writePccScorecardReport(
  ...
  files.push(
    await writeMd('pcc-live-scorecard-report.md', [
      ...
      '- Referenced through artifact inventory when provided.',
      '## 10. Package Completeness Review Summary',
      '- Verify evidence-package-completeness.json and evidence-package-completeness.md are included or exception-documented.',
      '## 11. Findings Register Summary',
      `- Findings count: ${run.summary.findingCount}`,
      '## 12. Residual Risk Summary',
      `- Residual risk count: ${run.summary.residualRiskCount}`,
      '## 13. Expert Review Instructions',
      '- Populate pillar manual scores in worksheet.',
      '- Keep hard-stop statuses manual-review-required until expert adjudication.',
      '- Keep final score blank until expert review.',
      '## 14. Final Judgment',
      'Final judgment: expert-review-required.',
      '',
    ]),
  ...
  files.push(
    await writeMd('manual-review-checklist.md', [
      ...
      '- [ ] Verify package-completeness artifacts are present or exception-documented.',
      '- [ ] Confirm screenshots are scrubbed and approved.',
      '- [ ] Confirm raw Playwright artifacts are excluded from curated package.',
      '- [ ] Confirm scorecard source references use canonical non-versioned path.',
      '- [ ] Record expert scores manually.',
      '- [ ] Keep pillar manual scores blank until expert review.',
      '- [ ] Record hard-stop dispositions manually.',
      '- [ ] Keep all hard-stop rows manual-review-required until expert adjudication.',
      '- [ ] Confirm surface-block and doctrine-source artifacts are included or operator-pending documented.',
  ...
  files.push(
    await writeMd('final-report-readme.md', [
      ...
      '- Package-completeness support artifacts should be included or exception-documented.',
      '- Surface-block and doctrine-source closeout artifacts should be included or operator-pending documented.',
